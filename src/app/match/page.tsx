...
export default async function MatchExplainerPage() {
  ...
  return (
    <div className="website-theme min-h-screen bg-white text-[#1a1a1a]" style={websiteCssVariables(content)}>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-8 lg:py-24">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/login?role=talent&next=%2Froles%2Fmatch" className="inline-flex items-center gap-2 bg-[#111111] px-6 py-3.5 text-[13px] font-semibold text-white">Sign in to start matching <ArrowRight size={15}/></Link>
                <Link href="/register/talent" className="inline-flex items-center gap-2 border border-[#cfd5da] bg-white px-6 py-3.5 text-[13px] font-semibold text-[#1a1a1a]">Create free profile</Link>
              </div>
            ...
            <div className="relative mx-auto w-full max-w-[440px] py-8">
              ...
              <div className="relative overflow-hidden border border-[#d9dee3] bg-white shadow-[0_24px_70px_rgba(16,40,59,.14)]">
                <div className="relative h-[235px] bg-[#111111]">
                ...
                <div className="p-6">
                  <div className="mb-5 flex items-start justify-between gap-4">
                    ...
                    <div className="shrink-0 border border-[#dbe1e5] bg-[#fafafa] px-4 py-2 text-center"><p className="text-[27px] font-semibold text-[#111111]">86%</p><p className="text-[9px] font-semibold uppercase tracking-[.1em] text-[#61707b]">Strong</p></div>
                  </div>
                  <div className="border-t border-[#e6eaed] pt-5">
                    <p className="text-[11px] font-semibold text-[#1a1a1a]">Why it fits</p>
                    <div className="mt-3 space-y-2 text-[12px] text-[#64717a]">
                      <p className="flex gap-2"><Check size={14} className="mt-0.5 text-[#111111]"/> Luxury spa experience aligns</p>
                      <p className="flex gap-2"><Check size={14} className="mt-0.5 text-[#111111]"/> Required treatment skills match</p>
                      <p className="flex gap-2"><Check size={14} className="mt-0.5 text-[#111111]"/> Within your preferred travel radius</p>
                    </div>
                  </div>
                  <div className="mt-6 grid grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center justify-center gap-2 bg-[#111111] py-3 text-[12px] font-semibold text-white"><Heart size={16}/> Swipe right</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white py-16 lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
            ...
            <div className="grid gap-px border border-[#e5e5e5] bg-[#e5e5e5] sm:grid-cols-2">
              {signals.map(signal => <div key={signal} className="flex items-center gap-3 bg-white px-5 py-5 text-[13px] font-medium text-[#33424d]"><Sparkles size={14} className="text-[#111111]"/>{signal}</div>)}
            </div>
          </div>
        </section>

        <section className="border-y border-[#e3e7ea] bg-[#111111] py-16 text-white">
          <div className="mx-auto flex max-w-6xl flex-col gap-7 px-6 md:flex-row md:items-center md:justify-between lg:px-8">
            ...
            <Link href="/login?role=talent&next=%2Froles%2Fmatch" className="inline-flex w-fit items-center gap-2 bg-white px-6 py-3.5 text-[13px] font-semibold text-[#111111]">Start matching <ArrowRight size={15}/></Link>
          </div>
        </section>
      </main>

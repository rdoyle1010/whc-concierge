      ...
      <main className="pt-[76px]">
        <section className="border-b border-[#e6e9ed] bg-white">
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-8 lg:py-24">
            <div className="max-w-2xl">
              ...
              <p className="mt-7 max-w-xl text-[16px] leading-7 text-[#5f6b74]">Think of it like a dating app for your career. Spa Platform ranks live roles around your real experience and preferences, then lets you review them one at a time.</p>
            ...
            <div className="relative mx-auto w-full max-w-[440px] py-8">
              <div className="absolute left-2 top-12 h-[470px] w-[90%] -rotate-3 border border-[#dce1e5] bg-[#f7f8fa]" />
              <div className="absolute right-2 top-10 h-[470px] w-[90%] rotate-3 border border-[#dce1e5] bg-white" />
              <div className="relative overflow-hidden border border-[#d9dee3] bg-white shadow-[0_24px_70px_rgba(16,40,59,.14)]">
                ...
                <div className="p-6">
                  <div className="mb-5 flex items-start justify-between gap-4">
                    ...
                    <div className="shrink-0 border border-[#dbe1e5] bg-[#f7f8fa] px-4 py-2 text-center"><p className="text-[27px] font-semibold text-[#0b2f4d]">86%</p><p className="text-[9px] font-semibold uppercase tracking-[.1em] text-[#61707b]">Strong</p></div>
                  </div>
        ...
        <section className="bg-[#f7f8fa] py-16 lg:py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid gap-px border border-[#dce1e5] bg-[#dce1e5] md:grid-cols-3">
        ...
        <section className="bg-white py-16 lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
            ...
            <div className="grid gap-px border border-[#dce1e5] bg-[#dce1e5] sm:grid-cols-2">

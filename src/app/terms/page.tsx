    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pb-24 px-4">
        <div className="max-w-3xl mx-auto text-[14px] text-secondary leading-[1.8] space-y-6">
          ...
          <p>Once a paid job listing is published, advertising fees are generally non-refundable except where required by law or expressly agreed by Talent House. Employers must advertise genuine opportunities and handle Talent data in accordance with applicable data-protection law.</p>

          <h2 className="text-[18px] font-medium text-ink mt-8">5. Agency Marketplace</h2>
          <p>Agency professionals set or agree their own hourly rate. The professional keeps 100% of the agreed shift value. Talent House charges the property an additional {agencyFeePct}% platform fee on top of that agreed shift value.</p>
          <p>For an accepted Agency shift, the property pays the professional&apos;s agreed shift value plus the Talent House platform fee through the Platform. Talent House records the payment and manages the professional payout after the completed shift, subject to any open cancellation, dispute, adjustment or safeguarding process. Where an approved shift adjustment creates extra professional pay, the same platform-fee percentage applies to that additional amount.</p>
          <p>Agency professionals may separately subscribe to the Agency Register. Basic is {AGENCY_LISTING_TIERS.basic.display} and Featured is {AGENCY_LISTING_TIERS.featured.display}. A paid Agency listing does not replace Talent House approval, verification, insurance requirements or availability checks.</p>
          ...
          <p>Residency is a specialist marketplace for longer-form placements. Listing, membership, booking and sourcing charges are shown before purchase. Where Talent House processes a Residency booking payment, the applicable platform fee and total are shown before the Employer confirms payment. Separate recruitment or executive-search fees may apply if Talent House is engaged to source or manage a search rather than simply provide marketplace access.</p>
          ...
          <p>Talent House&apos;s branding, platform design, software and original content remain the property of Wellness House Collective Ltd or its licensors. You retain ownership of content you submit but grant Talent House the rights reasonably required to host, display, process and use that content to operate the Platform and the services you request.</p>

          <h2 className="text-[18px] font-medium text-ink mt-8">13. Limitation of Liability</h2>
          <p>Talent House provides a platform, recruitment and marketplace service. Except where Talent House expressly contracts otherwise, Talent House does not employ Talent on behalf of an Employer and does not guarantee the accuracy of user-supplied information or the outcome of any application, engagement or booking. Nothing in these terms excludes liability that cannot lawfully be excluded.</p>
          ...
          <p>Talent House may change features or pricing from time to time. The price shown and accepted at checkout applies to that purchase. For recurring subscriptions, material pricing changes will be handled in accordance with applicable law and the payment provider&apos;s subscription process.</p>

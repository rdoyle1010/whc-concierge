    ...
    <DashboardShell role="talent" userName={profile?.full_name}>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-7">
        <div>
          ...
          <div className="mb-0 mt-3 inline-flex rounded-xl border border-[#e0e0e0] bg-white p-1 text-[12px] font-semibold"><span className="rounded-lg bg-[#0b2f4d] px-4 py-2 text-white">Browse list</span><a href="/roles/match" className="rounded-lg px-4 py-2 text-[#5c6a75] hover:text-[#0b2f4d]">Match deck</a></div>
            ...
            {paginatedSorted.map(job => {
              ...
              return (
                <article key={job.id} className="card p-0 overflow-hidden">
                  <div className="relative h-36 bg-[#e9e9e9] overflow-hidden">

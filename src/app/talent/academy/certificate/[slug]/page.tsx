...
export default function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] print:bg-white">
      <div className="print:hidden border-b border-[#e3e7eb] bg-white px-6 py-4 flex items-center justify-between max-w-4xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 print:py-0">
        <div className="bg-white border-[3px] border-double p-12 md:p-16 text-center" style={{ borderColor: '#5a6a76' }}>
          <p className="font-serif text-[20px] font-semibold text-black leading-none">Wellness House</p>
          <p className="uppercase text-[9px] font-medium tracking-[0.42em] mt-1 mb-10" style={{ color: '#5a6a76' }}>Collective</p>
          ...
          <div className="w-[80px] h-[1px] mx-auto mb-6" style={{ backgroundColor: '#5a6a76' }} />

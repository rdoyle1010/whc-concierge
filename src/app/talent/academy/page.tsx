  ...
  return (
    <DashboardShell role="talent">
      <div className="max-w-6xl">
        ...
        {career && (
          <div className="mb-8 rounded-2xl border border-[#e3e7eb] bg-[#f5f6f8] p-6">
              ...
              <div className="mt-5 border-t border-[#e3e7eb] pt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {career.progress.in_progress.map((item: any) => (
                    <Link key={item.slug} href={`/talent/academy/${item.slug}`} className="inline-flex items-center gap-2 rounded-xl border border-[#e3e7eb] bg-white px-3.5 py-2 text-[12px] font-medium text-ink hover:border-[#10283b]">
                      {item.title}
              ...
              <div className="mt-5 border-t border-[#e3e7eb] pt-4">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {career.gaps.map((gap: any) => (
                    <div key={gap.skill} className="rounded-xl border border-[#e3e7eb] bg-white p-3.5">
              ...
              <div className="mt-5 border-t border-[#e3e7eb] pt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {career.pathway.map((item: any) => (
                    <Link key={item.slug} href={`/talent/academy/${item.slug}`} className="inline-flex items-center gap-2 rounded-xl border border-[#e3e7eb] bg-white px-3.5 py-2 text-[12px] font-medium text-ink hover:border-[#10283b]">
                      {item.title}
                      <span className="rounded-full bg-[#f5f6f8] px-2 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-[#10283b]">{item.level}</span>
                    </Link>
                  ))}
                </div>
              </div>

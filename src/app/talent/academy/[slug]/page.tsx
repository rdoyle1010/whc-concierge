              ...
              {rich ? (
                ...
                <>
                  ...
                  <div className="grid gap-3 md:grid-cols-3 mb-6">
                    <div className="rounded-xl bg-surface p-4"><Target size={15} className="mb-2 text-[#10283b]" /><p className="text-[11px] font-semibold text-ink">Understand the reason</p><p className="mt-1 text-[11px] leading-5 text-gray-600">Each module connects the topic to guest experience, people, profit or operational risk.</p></div>
                    <div className="rounded-xl bg-surface p-4"><Lightbulb size={15} className="mb-2 text-[#10283b]" /><p className="text-[11px] font-semibold text-ink">Make the judgement</p><p className="mt-1 text-[11px] leading-5 text-gray-600">Consider trade-offs, unintended consequences and the numbers behind the decision.</p></div>
                    <div className="rounded-xl bg-surface p-4"><FileText size={15} className="mb-2 text-[#10283b]" /><p className="text-[11px] font-semibold text-ink">Apply the learning</p><p className="mt-1 text-[11px] leading-5 text-gray-600">Use the management labs and final assessment to turn theory into a plan you could use at work.</p></div>
                  </div>
                </>
              )}

...
export default function TalentVerificationPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setNotice('Submitted - Talent House will review your right-to-work evidence and any optional documents you provided.')
  ...
  return <DashboardShell role="talent">
    <div className="max-w-2xl">
      ...
      <h1 className="dashboard-title">Talent House Verified</h1>
      <p className="dashboard-intro mb-6">Right to work is essential for Agency and employment opportunities. Talent House reviews your evidence for the UK, Ireland or both. Insurance is separate and optional because not every role or professional requires their own policy.</p>
      ...
      : status === 'pending' ? <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-6"><p className="text-sm font-medium text-amber-800">Right-to-work evidence under review</p><p className="text-xs text-amber-700 mt-1">Talent House will review the documents before marking your account verified.</p></div>

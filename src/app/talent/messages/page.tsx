            ...
            <div className="flex-1 overflow-y-auto">
              {loading ? (
                ...
                <div className="flex h-full flex-col items-center justify-center px-8 text-center">
                  ...
                  <p className="mt-2 text-[12px] leading-5 text-[#8a949b]">When interest is mutual, the property conversation will appear here automatically.</p>
                </div>
          ...
          <section className={`${activeConvo ? 'flex' : 'hidden md:flex'} min-w-0 flex-1 flex-col bg-[#f5f6f8]`}>
            {!activeConvo ? (
              <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
                ...
                <p className="mt-2 max-w-sm text-[12px] leading-5 text-[#8a949b]">Matched properties and protected Residency discussions will stay organised here.</p>
              </div>
            ) : (
              <>

            ...
            <div className="flex-1 overflow-y-auto">
              {loading ? (
                ...
                <div className="flex h-full flex-col items-center justify-center px-8 text-center">
                  ...
                  <p className="mt-2 text-[12px] leading-5 text-[#6b7580]">When interest is mutual, the property conversation will appear here automatically.</p>
                </div>
          ...
          <section className={`${activeConvo ? 'flex' : 'hidden md:flex'} min-w-0 flex-1 flex-col bg-[#f5f6f8]`}>
            {!activeConvo ? (
              <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
                ...
                <p className="mt-2 max-w-sm text-[12px] leading-5 text-[#6b7580]">Matched properties and protected Residency discussions will stay organised here.</p>
              </div>
            ) : (
              <>
                ...
                <div className="border-t border-[#e3e7eb] bg-white p-3 md:p-4">
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <button type="button" onClick={sendMessage} aria-label="Send message" className="flex h-11 w-11 shrink-0 items-center justify-center bg-accent text-white transition hover:bg-[#123f64] disabled:opacity-50" disabled={attachmentUploading || (!newMsg.trim() && !attachmentFile)}><Send size={17} /></button>
                  </div>
                </div>
              </>
            )}

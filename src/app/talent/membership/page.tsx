...
export default function TalentMembershipPage() {
  ...
  return <DashboardShell role="talent"><div className="mb-8"><p className="dashboard-eyebrow">Membership</p><h1 className="dashboard-title">Build your career with WHC</h1><p className="dashboard-intro">Free stays genuinely useful. Upgrade when you want deeper preparation, more Interview Ready access and stronger visibility.</p></div>

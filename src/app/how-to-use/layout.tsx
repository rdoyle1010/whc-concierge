...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How Talent House Works | For Professionals and Properties', description: 'One platform for spa careers and recruitment: roles, agency shifts, residency, consultancy and CPD training, and how each side uses it.' },
}

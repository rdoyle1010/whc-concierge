              ...
              <div key={row.id} className="dashboard-card">
                <div className="flex flex-wrap items-start justify-between gap-3 mb-2">
                  <div className="min-w-0">
                    <p className="text-[15px] font-semibold text-ink inline-flex items-center gap-1.5"><Briefcase size={14} className="text-[#8a6d3b]" /> {row.job_title}{row.service === 'executive' ? ' · Executive search' : ''}</p>
                ...
                <p className="text-[12.5px] text-gray-700 leading-relaxed bg-[#f7f8fa] rounded-lg px-3 py-2.5 mb-3 whitespace-pre-wrap">{row.brief}</p>

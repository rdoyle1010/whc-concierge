...
const SECTIONS = [
  ...
  { group: 'People & operations', label: 'Platform Reviews', desc: 'Read Talent and property feedback about Talent House Collective.', href: '/admin/platform-reviews', icon: <MessageSquare size={17} /> },
      ...
      <section className="dashboard-panel mb-8 overflow-hidden !p-0">
        ...
        {healthLoading ? (
          ...
          <>
            ...
            {health.scale && (
              <div className="border-t border-border bg-[#ede8df] px-5 py-4">
...
function FunnelCell({ label, value, emphasis = false }: { label: string; value: number; emphasis?: boolean }) {
  return (
    <div className={emphasis ? 'bg-[#f3f8f5] px-4 py-4' : 'bg-[#ede8df] px-4 py-4'}>

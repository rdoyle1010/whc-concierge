    ...
    {showForm && <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#07243b]/70 p-4" onClick={() => setShowForm(false)}>
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-7 md:p-9" onClick={e => e.stopPropagation()}>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl bg-[#eef2f4] p-4 flex gap-3"><Share2 size={18} className="text-[#0b2f4d] shrink-0 mt-0.5"/><div><p className="text-[12px] font-semibold text-[#10283b]">Social sharing is automatic</p><p className="text-[11px] text-[#555555] mt-1">Published articles get LinkedIn, Facebook, WhatsApp, Email and Copy Link buttons on the article page.</p></div></div>

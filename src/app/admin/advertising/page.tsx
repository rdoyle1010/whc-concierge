...
export default function AdminAdvertisingPage() {
  ...
  const paid = adverts.filter(advert => advert.payment_status === 'paid')
  const live = paid.filter(advert => advert.status === 'active' && advert.review_status === 'approved')

...
export default function AdminSettingsPage() {
  ...
  return <DashboardShell role="admin" userName="Admin">
    ...
    {loading ? <div className="flex h-64 items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-2 border-[#10283b] border-t-transparent" /></div> : <div className="max-w-4xl space-y-6">
      ...
      <div className="dashboard-card"><p className="text-[15px] font-semibold text-ink mb-4">Infrastructure</p><div className="grid gap-3 md:grid-cols-3"><div className="rounded-xl bg-[#f5f6f8] p-4"><p className="text-[12px] font-semibold text-ink">Supabase</p><p className="mt-1 text-[11px] text-muted">WHC production project</p></div><div className="rounded-xl bg-[#f5f6f8] p-4"><p className="text-[12px] font-semibold text-ink">Stripe</p><p className="mt-1 text-[11px] text-muted">Live keys via environment</p></div><div className="rounded-xl bg-[#f5f6f8] p-4"><p className="text-[12px] font-semibold text-ink">Storage</p><p className="mt-1 text-[11px] text-muted">Private candidate documents and site assets</p></div></div></div>
    </div>}
  </DashboardShell>
}

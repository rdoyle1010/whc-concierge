            ...
            <div className="p-4 flex flex-col md:flex-row md:items-center gap-3">
              ...
              <button onClick={() => setOpenCourse(open ? null : course.slug)} className="text-left flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {course.level && <span className="text-[10px] font-semibold uppercase px-2 py-0.5 bg-[#ede8df] text-[#222321]">{course.level}</span>}
                  {course.content_source === 'custom'
                    ? <span className="inline-flex items-center gap-1 text-[10px] font-semibold uppercase px-2 py-0.5 bg-[#222321] text-white"><PencilLine size={10} /> Your version</span>

  ...
  return <DashboardShell role="admin" userName="Admin">
    ...
    {showForm && <div className="fixed inset-0 z-[70] bg-[#071d2d]/70 p-3 md:p-6 overflow-y-auto"><div className="mx-auto max-w-6xl rounded-[24px] bg-white shadow-2xl overflow-hidden">
      ...
      <div className="grid lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="bg-[#eef2f4] p-5 md:p-7 lg:sticky lg:top-0 lg:h-[calc(100vh-70px)] overflow-auto"><p className="text-[10px] uppercase tracking-[.16em] text-[#555555] mb-3">Live preview</p><iframe title="Newsletter preview" srcDoc={previewHtml} className="w-full h-[760px] bg-white rounded-[16px] shadow-sm border border-[#e5e5e5]"/></div>
      </div>
    </div></div>}
...
function Section({title,children}:{title:string;children:React.ReactNode}){return <section><h3 className="text-[13px] font-semibold text-[#1a1a1a] mb-4">{title}</h3><div className="space-y-4">{children}</div></section>}

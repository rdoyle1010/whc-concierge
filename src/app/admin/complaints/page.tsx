...
export default function AdminComplaintsPage() {
  ...
  return (
    <DashboardShell role="admin" userName="Admin">
        ...
        <div className="space-y-4">
          {filtered.map((c) => (
            <div key={c.id} className="dashboard-card">
              ...
              <div className="flex space-x-2 mt-4 pt-4 border-t border-[#dcd4c8]">
      ...
      {/* Detail modal */}
      {selected && (
        <div className="fixed inset-0 bg-[#161814]/70 z-50 flex items-center justify-center p-4" onClick={() => setSelected(null)}>
          <div {...detailDialog.panelProps} className="bg-white rounded-3xl max-w-lg w-full p-8 animate-fade-in-up">
            ...
            <div className="mt-4 p-4 bg-[#ede8df] rounded-xl">
            ...
            <div className="mt-5 pt-5 border-t border-[#dcd4c8]">

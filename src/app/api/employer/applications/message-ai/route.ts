...
function fallbackMessage(intent: Intent, candidate: any, job: any, employer: any) {
...
export async function POST(req: NextRequest) {
  try {
    ...
    const drafted = await askForText({ label: 'employer message', system: HOUSE_RULES, prompt, maxTokens: 1400 })

...
async function sendHireConfirmation(email: string, name: string, jobTitle: string, propertyName: string) {
  ...
  const html = `<!doctype html><html><body style="margin:0;background:#ffffff;font-family:Arial,Helvetica,sans-serif;color:#10283b;"><div style="max-width:580px;margin:32px auto;background:#ffffff;border:1px solid #e5e5e5;"><div style="background:#0b2f4d;padding:26px 34px;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#ffffff;opacity:.8;">Congratulations</p><h1 style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:24px;font-weight:600;">WHC Concierge</h1></div><div style="padding:30px 34px;"><h2 style="margin:0 0 14px;font-family:Arial,Helvetica,sans-serif;font-weight:600;font-size:19px;">Congratulations, ${escapeHtml(firstName)}</h2><p style="line-height:1.7;color:#516371;">Your offer for <strong>${escapeHtml(jobTitle)}</strong> with <strong>${escapeHtml(propertyName)}</strong> has been accepted and the recruitment process on WHC Concierge is now complete.</p><p style="line-height:1.7;color:#516371;">Your employer will send any formal employment documents, contractual terms and onboarding information directly to you.</p><p style="line-height:1.7;color:#516371;">Your WHC Concierge account remains yours. You can access, update or request deletion of your personal information through Settings. Some recruitment records may be retained only where necessary for legitimate or legal purposes in line with our privacy notice.</p><p style="margin-top:26px;"><a href="https://talent.wellnesshousecollective.co.uk/talent/settings" style="display:inline-block;background:#0b2f4d;color:#ffffff;text-decoration:none;padding:12px 18px;">Privacy & account settings</a></p><p style="margin-top:30px;font-size:12px;color:#8a949b;">Wellness House Collective · WHC Concierge</p></div></div></body></html>`

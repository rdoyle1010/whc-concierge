...
async function sendHireConfirmation(email: string, name: string, jobTitle: string, propertyName: string) {
  ...
  const html = `<!doctype html><html><body style="margin:0;background:#f5f3ee;font-family:Arial,sans-serif;color:#17344d;"><div style="max-width:580px;margin:32px auto;background:#fff;padding:34px;border-radius:18px;"><p style="font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#1a1a1a;">Congratulations</p><h1 style="font-family:Georgia,serif;font-weight:500;">Congratulations, ${escapeHtml(firstName)}</h1><p style="line-height:1.7;color:#516371;">Your offer for <strong>${escapeHtml(jobTitle)}</strong> with <strong>${escapeHtml(propertyName)}</strong> has been accepted and the recruitment process on Spa Platform is now complete.</p><p style="line-height:1.7;color:#516371;">Your employer will send any formal employment documents, contractual terms and onboarding information directly to you.</p><p style="line-height:1.7;color:#516371;">Your Spa Platform account remains yours. You can access, update or request deletion of your personal information through Settings. Some recruitment records may be retained only where necessary for legitimate or legal purposes in line with our privacy notice.</p><p style="margin-top:26px;"><a href="https://talent.wellnesshousecollective.co.uk/talent/settings" style="display:inline-block;background:#111111;color:white;text-decoration:none;padding:12px 18px;border-radius:9px;">Privacy & account settings</a></p><p style="margin-top:30px;font-size:12px;color:#9b958b;">Wellness House Collective · Spa Platform</p></div></body></html>`

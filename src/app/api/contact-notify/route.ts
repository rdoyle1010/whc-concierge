    ...
    const html = `
      <div style="font-family: Inter, -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
          <tr><td style="padding: 8px 0; color: #6e6a60; font-size: 13px; width: 100px;">Name</td><td style="padding: 8px 0; font-size: 14px; color: #222321; font-weight: 500;">${name}</td></tr>
          <tr><td style="padding: 8px 0; color: #6e6a60; font-size: 13px;">Email</td><td style="padding: 8px 0; font-size: 14px;"><a href="mailto:${email}" style="color: #57544c;">${email}</a></td></tr>
          <tr><td style="padding: 8px 0; color: #6e6a60; font-size: 13px;">Type</td><td style="padding: 8px 0; font-size: 14px; color: #222321; text-transform: capitalize;">${type || 'general'}</td></tr>
          <tr><td style="padding: 8px 0; color: #6e6a60; font-size: 13px;">Subject</td><td style="padding: 8px 0; font-size: 14px; color: #222321; font-weight: 500;">${subject}</td></tr>
        </table>
        <div style="background: #ede8df; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
          <p style="font-size: 12px; color: #6e6a60; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.05em;">Message</p>
          <p style="font-size: 14px; color: #374151; line-height: 1.7; white-space: pre-wrap;">${message}</p>
        </div>
        <p style="font-size: 12px; color: #6e6a60;">Talent House Collective &middot; talenthousecollective.co.uk</p>
      </div>
    `

...
export default function ResidencyPage() {
  ...
  return <div className="public-page">
    ...
    {justSubmitted && <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-[76px]"><div role="status" className="border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800">Listing submitted. It will go live once the WHC Concierge team approves it.</div></div>}

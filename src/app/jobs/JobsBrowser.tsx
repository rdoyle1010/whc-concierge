...
export default function PublicJobsBrowser() {
  ...
  function swipeCard(job: any) {
    ...
    return <article className="h-[500px] overflow-hidden border border-border bg-white shadow-sm">
      <div className="relative h-52 overflow-hidden bg-[#ede8df]">
      ...
      <div className="p-7">
        <div className="flex flex-wrap items-center justify-between gap-3">
          {job.is_residency_role ? <span className="bg-[#e3dcd1] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[.1em] text-accent">Residency</span> : <span/>}

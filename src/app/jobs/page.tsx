...
export default function PublicJobsPage() {
  ...
  function swipeCard(job: any) {
    ...
    return <article className={`h-[500px] overflow-hidden rounded-3xl border bg-white shadow-xl ${rank >= 3 ? 'border-[#5a6a76]/55' : 'border-border'}`}>
      <div className="relative h-52 bg-[#f5f6f8] overflow-hidden">
        ...
        {rank >= 3 && <div className="absolute left-5 top-5 inline-flex items-center gap-2 rounded-full bg-white/95 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-ink"><Sparkles size={12} style={{color:'#5a6a76'}}/>{rank===4?'Top opportunity':'Featured role'}</div>}
      </div>

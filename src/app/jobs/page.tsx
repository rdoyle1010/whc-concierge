...
export default function PublicJobsPage() {
  ...
  function swipeCard(job: any) {
    ...
    return <article className={`h-[500px] overflow-hidden rounded-3xl border bg-white shadow-xl ${rank >= 3 ? 'border-[#555555]/55' : 'border-border'}`}>
      <div className="relative h-52 bg-[#e9e9e9] overflow-hidden">

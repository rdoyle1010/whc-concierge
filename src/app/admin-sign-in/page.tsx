    ...
    <main id="main-content" className="min-h-screen bg-[#ede8df] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-[430px]">
        ...
        <div className="mt-10 dashboard-card !p-8">
          ...
          <p className="text-[12px] text-muted mt-6">Talent or employer? <Link href="/login" className="text-[#222321] font-semibold hover:underline">Use the main sign in</Link>.</p>
        </div>
      </div>
    </main>
  )

  ...
  return <div className="min-h-screen bg-[#ede8df] text-[#222321]">
    ...
    <main id="main-content" className="pt-[76px]">
      ...
      <section className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        <div className="rounded-[22px] border border-[#dcd4c8] bg-white p-7 md:p-10 space-y-7 text-[13px] leading-7 text-[#57544c]">
          <div><h2 className="text-[18px] font-semibold text-[#222321]">1. The booking</h2><p>A sponsored placement is a rolling monthly advertising subscription for the placement selected at checkout. The price shown at checkout is charged monthly until the subscription is cancelled, subject to any valid promotion or discount applied by Stripe.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#222321]">2. Billing and duration</h2><p>Billing begins when Stripe checkout is completed. The subscription renews automatically each month until cancelled. A promotion code may reduce a charge, including to £0 where the code permits, but does not change the recurring nature of the subscription unless Stripe states otherwise.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#222321]">3. Approval before publication</h2><p>Payment does not guarantee publication. Talent House reviews the supplied brand name, wording, website destination and creative before the advert appears publicly. Talent House may request changes or reject material that is inaccurate, unlawful, misleading, unsuitable for the audience, inconsistent with platform standards or technically unsafe.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#222321]">4. When the advert goes live</h2><p>The public display period starts when Talent House approves and activates the advert. Talent House aims to review submissions within two working days, but this is not a guaranteed service level. The subscription billing cycle remains the Stripe billing cycle that began at checkout.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#222321]">5. Placement</h2><p>The advert will be displayed in the placement purchased, subject to platform availability, responsive layouts and normal product changes. Sponsored content will be clearly identified as sponsored advertising.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#222321]">6. Advertiser responsibilities</h2><p>You confirm that you are authorised to use the supplied logos, images, wording, trademarks and destination links and that your advert complies with applicable law and advertising rules. You remain responsible for claims made in the advert and on the linked website.</p></div>

    ...
    <main id="main-content" className="pt-[76px]">
      ...
      <section className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        <div className="rounded-[22px] border border-[#dddddd] bg-white p-7 md:p-10 space-y-7 text-[13px] leading-7 text-[#555555]">
          ...
          <div><h2 className="text-[18px] font-semibold text-[#1c1c1c]">7. Tracking and performance</h2><p>WHC may report impressions and clicks generated through the platform. WHC does not guarantee a minimum number of impressions, clicks, enquiries, applications, sales or other commercial outcomes.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#1c1c1c]">8. Pausing, rejection and removal</h2><p>WHC may pause or remove an advert where there is a payment issue, policy issue, legal concern, broken destination, misleading claim or material change that makes the advert unsuitable. If creative is rejected, WHC may work with the advertiser on reasonable amendments before publication.</p></div>
          <div><h2 className="text-[18px] font-semibold text-[#1c1c1c]">9. Cancellation</h2><p>You may cancel the recurring subscription so that it does not renew for a further billing period. Cancellation does not ordinarily refund a billing period already started, except where required by law or agreed by WHC.</p></div>

...
export default function MfaChallengePage() {
  return <Suspense fallback={<div className="min-h-screen bg-[#ede8df]" />}><MfaChallenge /></Suspense>
}
...
function MfaChallenge() {
  ...
  return <main id="main-content" className="min-h-screen bg-[#ede8df] flex items-center justify-center px-5 py-10">
    <div className="w-full max-w-[430px]">
      <Wordmark />
      <div className="dashboard-card !p-7 lg:!p-8 mt-9">
        <div className="h-11 w-11 rounded-full bg-[#222321] text-white flex items-center justify-center mb-5"><ShieldCheck size={20}/></div>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="dashboard-card lg:col-span-2">
          ...
          <div className="dashboard-card flex items-center justify-between !p-4">
            <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-[#222321]/10 flex items-center justify-center text-[#222321]"><CreditCard size={18} /></div><div><p className="text-[13px] font-medium text-ink">Stripe Payment Methods</p><p className="text-[12px] text-muted mt-0.5">Manage stored cards and active subscriptions</p></div></div>
        ...
        <div className="dashboard-card border-[#57544c]/50">
          <div className="flex items-center gap-2 text-[#222321]"><Star size={16} /><p className="text-[14px] font-semibold">Featured Hotel</p></div>

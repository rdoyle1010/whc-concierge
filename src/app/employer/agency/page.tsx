...
export default function EmployerAgencyPage() {
  ...
  const statusColors: Record<string, string> = {
    pending: 'bg-amber-50 text-amber-700', countered: 'bg-[#FDF6EC] text-accent', accepted: 'bg-blue-50 text-blue-700', confirmed: 'bg-green-50 text-green-700', completed: 'bg-blue-50 text-blue-700', declined: 'bg-red-50 text-red-700', cancelled: 'bg-red-50 text-red-700', expired: 'bg-gray-100 text-gray-500',
  }

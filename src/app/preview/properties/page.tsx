...
import { renderProperties } from '@/app/properties/page'

// The administrator's view of unpublished copy for /properties.
//
...
export default async function DraftPreview() {
  ...
  if (!user) redirect('/admin/login?redirect=/preview/properties')

      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1.5">
            ...
            {c.agency_ready && <span className="text-[9px] font-semibold uppercase tracking-[.08em] bg-[#0b2f4d] text-white px-2 py-1 inline-flex items-center gap-1"><ShieldCheck size={10} />Agency Ready</span>}
          </div>
        </div>
      </div>

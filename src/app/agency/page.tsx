...
export default function AgencyPage() {
  ...
  function candidateCard(c:any, fixedHeight = false){
    ...
    const verifiedLine = [c.whc_verified ? 'Talent House Verified' : null, c.has_insurance ? 'Insured' : null].filter(Boolean).join(' · ')
    ...
    return <DashboardShell role="employer">
      <div className="max-w-5xl mx-auto">
        <section className="pt-4 pb-14 md:pb-16">
          ...
          <p className="mt-6 text-[15px] leading-7 text-secondary max-w-2xl">Agency Cover is the Talent House register of self-employed spa professionals available for individual shifts at hotels and spas across the UK. Search by date, hours and distance, review a verified profile and send an offer - nothing is booked until both sides agree.</p>

    ...
    <main id="main-content" className="pt-[76px]">
      ...
      <section className="py-16 px-6 bg-white border-b border-[#dcd4c8]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-5">
          ...
          <div className="rounded-[22px] bg-[#ede8df] border border-[#dcd4c8] p-7"><p className="text-[10px] uppercase tracking-[.16em] font-semibold text-[#222321]">Executive Search</p><h3 className="text-[28px] font-semibold text-[#222321] mt-2">15–20% of first-year salary</h3><p className="text-[12px] leading-6 text-[#57544c] mt-3">For Director of Spa, Wellness Director, Regional leadership, Group Spa Director and other senior confidential searches.</p></div>
        </div>
      </section>

      <section className="py-16 px-6 bg-[#ede8df] border-b border-[#dcd4c8]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-5">
          <div className="rounded-[22px] bg-white border border-[#dcd4c8] p-6"><p className="text-[10px] uppercase tracking-[.16em] font-semibold text-[#222321]">Academy</p><h3 className="text-[22px] font-semibold text-[#222321] mt-2">{academyPrices ? (academyPrices.low === academyPrices.high ? pounds(academyPrices.low) : `${pounds(academyPrices.low)}-${pounds(academyPrices.high)}`) : 'See the Academy'}</h3><p className="text-[12px] text-[#57544c] mt-3">Free members pay standard price. Standard members receive 10% off. Pro members receive 20% off.</p></div>
          <div className="rounded-[22px] bg-white border border-[#dcd4c8] p-6"><p className="text-[10px] uppercase tracking-[.16em] font-semibold text-[#222321]">Brand exposure</p><h3 className="text-[22px] font-semibold text-[#222321] mt-2">From £295</h3><p className="text-[12px] text-[#57544c] mt-3">Brand Spotlight £295, Industry Feature £495 and Partner Campaigns from £995.</p></div>

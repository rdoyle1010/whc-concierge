    ...
    <tr><td align="center" style="padding: 40px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
        ...
        <tr><td style="background: linear-gradient(145deg, #0f0e0d, #1c1b1a); border-radius: 12px 12px 0 0; padding: 40px 40px 32px; text-align: center;">
          <p style="margin: 0 0 8px; font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: rgba(28,27,26, 0.6);">Welcome to</p>
          <h1 style="margin: 0; font-size: 28px; font-weight: 700; color: #555555; letter-spacing: -0.5px;">WHC Concierge</h1>
        </td></tr>

        <!-- Body -->
        <tr><td style="background-color: #FFFFFF; padding: 40px;">
          <h2 style="margin: 0 0 16px; font-size: 22px; font-weight: 600; color: #1c1b1a;">Hello, ${firstName}</h2>
          <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.7; color: #3a3835;">${mainMessage}</p>

          <!-- Next steps -->
          <p style="margin: 0 0 12px; font-size: 13px; font-weight: 600; color: #1c1b1a; text-transform: uppercase; letter-spacing: 0.5px;">Your next steps</p>
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
            ${nextSteps.map((step, i) => `
            <tr><td style="padding: 8px 0; font-size: 14px; line-height: 1.6; color: #3a3835;">
              <span style="display: inline-block; width: 22px; height: 22px; line-height: 22px; text-align: center; background-color: #f3f0eb; color: #555555; border-radius: 50%; font-size: 11px; font-weight: 600; margin-right: 10px; vertical-align: middle;">${i + 1}</span>
              ${step}
            </td></tr>`).join('')}
          </table>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
              <a href="${dashboardUrl}" style="display: inline-block; padding: 14px 32px; background-color: #1c1b1a; color: #FFFFFF; font-size: 14px; font-weight: 600; text-decoration: none; border-radius: 8px; letter-spacing: 0.3px;">${ctaText}</a>
            </td></tr>
          </table>
        </td></tr>

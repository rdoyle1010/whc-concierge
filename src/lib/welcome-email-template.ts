    ...
    <tr><td align="center" style="padding: 40px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
        ...
        <tr><td style="background: linear-gradient(145deg, #07243b, #10283b); border-radius: 12px 12px 0 0; padding: 40px 40px 32px; text-align: center;">
          <p style="margin: 0 0 8px; font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: rgba(16, 47, 77, 0.6);">Welcome to</p>
        ...
        <tr><td style="background-color: #FFFFFF; padding: 40px;">
          ...
          <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.7; color: #3d4b57;">${mainMessage}</p>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
            ...
            <tr><td style="padding: 8px 0; font-size: 14px; line-height: 1.6; color: #3d4b57;">
              <span style="display: inline-block; width: 22px; height: 22px; line-height: 22px; text-align: center; background-color: #f5f6f8; color: #555555; border-radius: 50%; font-size: 11px; font-weight: 600; margin-right: 10px; vertical-align: middle;">${i + 1}</span>
              ${step}
            </td></tr>`).join('')}
          </table>
        ...
        <tr><td style="background-color: #fafafa; border-radius: 0 0 12px 12px; padding: 28px 40px; border-top: 1px solid #e3e7eb;">
          ...
          <p style="margin: 0; font-size: 11px; color: #d9d9d9;">You received this email because you created an account on WHC Concierge. To stop receiving emails, you can delete your account from your settings page.</p>
        </td></tr>

    ...
    <tr><td align="center" style="padding: 40px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
        ...
        <tr><td style="background-color: #FFFFFF; padding: 40px;">
            ...
            <tr><td style="padding: 20px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                ${location ? `<tr>
                  ...
                  <td style="padding: 6px 0; font-size: 14px; color: #1c1c1c;">${location}</td>
                </tr>` : ''}
                ${salary ? `<tr>
                  <td style="padding: 6px 0; font-size: 12px; color: #8c8c8c; vertical-align: top;">Salary</td>
                  <td style="padding: 6px 0; font-size: 14px; color: #1c1c1c; font-weight: 500;">${salary}</td>
                </tr>` : ''}
                <tr>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
              <a href="https://talenthousecollective.co.uk/roles/match" style="display: inline-block; padding: 14px 32px; background-color: #1c1c1c; color: #FFFFFF; font-size: 14px; font-weight: 600; text-decoration: none; border-radius: 8px;">View This Role</a>
            </td></tr>
          </table>
        </td></tr>

    ...
    <tr><td align="center" style="padding: 40px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
        ...
        <tr><td style="background: linear-gradient(145deg, #07243b, #10283b); border-radius: 12px 12px 0 0; padding: 40px 40px 32px; text-align: center;">
          <p style="margin: 0 0 8px; font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: rgba(16, 47, 77, 0.6);">New Role Alert</p>
        ...
        <tr><td style="background-color: #FFFFFF; padding: 40px;">
          ...
          <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.7; color: #3d4b57;">A role has just been posted that aligns with your skills and experience.</p>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #fafafa; border-radius: 8px; margin-bottom: 24px;">
            <tr><td style="padding: 20px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                ${location ? `<tr>
                  <td style="padding: 6px 0; font-size: 12px; color: #8a949b; vertical-align: top;">Location</td>
                  <td style="padding: 6px 0; font-size: 14px; color: #10283b;">${location}</td>
                </tr>` : ''}
                ${salary ? `<tr>
                  <td style="padding: 6px 0; font-size: 12px; color: #8a949b; vertical-align: top;">Salary</td>
                  <td style="padding: 6px 0; font-size: 14px; color: #10283b; font-weight: 500;">${salary}</td>
                </tr>` : ''}
                <tr>
                  <td style="padding: 6px 0; font-size: 12px; color: #8a949b; vertical-align: top;">Match</td>

...
const CORE_META: Record<string, CourseMeta> = {
  'consultation-excellence': { level: 'Professional', skills: ['Consultation', 'Guest Experience'], cpdHours: 1.5 },
  'retail-excellence': { level: 'Professional', skills: ['Retail', 'Product Recommendation', 'Upselling'], cpdHours: 1.5 },
  'five-star-service': { level: 'Foundation', skills: ['Customer Service', 'Guest Experience'], cpdHours: 1.5 },
  'lqa-forbes-standards': { level: 'Professional', skills: ['LQA Standards', 'Forbes Standards', 'Luxury Service Standards'], cpdHours: 1.5 },
  'health-safety-hygiene': { level: 'Foundation', skills: ['Health & Safety', 'Hygiene', 'COSHH'], cpdHours: 1.5 },
  'room-standards': { level: 'Foundation', skills: ['Treatment Room Standards', 'Presentation'], cpdHours: 1 },
  'upgrading-treatments': { level: 'Professional', skills: ['Upselling', 'Treatment Enhancement', 'Retail'], cpdHours: 1 },
  'personal-presentation': { level: 'Foundation', skills: ['Personal Presentation', 'Professionalism'], cpdHours: 0.5 },
  'perfect-massage': { level: 'Professional', skills: ['Massage', 'Swedish Massage', 'Deep Tissue Massage'], cpdHours: 1.5 },
  'perfect-facial': { level: 'Professional', skills: ['Facial', 'Skin Analysis', 'Classic Facial'], cpdHours: 1 },
  'brand-knowledge': { level: 'Professional', skills: ['Product Knowledge', 'Product Houses'], cpdHours: 1 },
  'cancer-care-awareness': { level: 'Professional', skills: ['Cancer Care Awareness', 'Adapted Treatments', 'Specialist Care'], cpdHours: 1.5 },
  'menopause-aware-spa': { level: 'Professional', skills: ['Menopause Awareness', 'Specialist Care'], cpdHours: 1.5 },
  'pregnancy-postnatal-spa': { level: 'Professional', skills: ['Pregnancy Massage', 'Postnatal Care', 'Specialist Care'], cpdHours: 1.5 },
  'spa-revenue-fundamentals': { level: 'Professional', skills: ['Revenue Management', 'Commercial Performance', 'KPIs', 'Yield Management'], cpdHours: 1.5 },
  ...
  'spa-director-programme': { level: 'Leadership', skills: ['Leadership', 'Strategy', 'Budgeting', 'P&L Management', 'Revenue Management', 'Pre-opening', 'Commercial Performance'], cpdHours: 5 },
}

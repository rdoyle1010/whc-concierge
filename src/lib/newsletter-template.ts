...
<body style="margin:0;background:#f3f6f8;font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Arial,sans-serif;color:#10283b">
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f3f6f8;padding:28px 12px">
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:${maxWidth}px;background:#ffffff;border:1px solid #e3e7eb;border-radius:20px;overflow:hidden">
        ...
        <tr><td style="background:#f7f9fa;border-top:1px solid #e3e7eb;padding:24px 30px;font-size:11px;line-height:1.65;color:#73818a">
          <div style="font-weight:600;color:#53636f;margin-bottom:7px">Wellness House Collective</div>
          <div>${footer}</div>
          ...
          ${opts.test
            ...
            : opts.unsubscribeUrl
              ? `<div style="margin-top:10px">You are receiving this optional email because you confirmed your WHC marketing or newsletter preference. <a href="${escapeHtml(opts.unsubscribeUrl)}" style="color:#53636f">Unsubscribe</a> · <a href="https://talent.wellnesshousecollective.co.uk/privacy" style="color:#53636f">Privacy policy</a></div>`
              : ''}
        </td></tr>
      </table>
    </td></tr>

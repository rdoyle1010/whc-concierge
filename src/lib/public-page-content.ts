...
export const DEFAULT_PUBLIC_PAGES_CONTENT: PublicPagesContent = {
  ...
  pages: {
    properties: {
      ...
      blocks: [
        block('Verified partners', 'Properties building their teams with us.', 'Discover properties using Talent House Collective to recruit and book exceptional wellness professionals.', 'https://images.unsplash.com/photo-1600334129128-685c5582fd35?auto=format&fit=crop&q=82&w=1600', 'Luxury spa treatment'),
    ...
    'coming-soon': {
      ...
      blocks: [
        ...
        block('Hospitality expansion', 'From spa into the departments that make hospitality work.', 'Brands and product houses come next. Then events, food and beverage, front of house and housekeeping, starting with the properties we already work with.', 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&q=82&w=1600', 'Hospitality property'),

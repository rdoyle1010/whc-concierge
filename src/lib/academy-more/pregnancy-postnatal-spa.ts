...
export const content: CourseContent = {
  ...
  lessons: [
    {
      title: 'The pregnant and post-natal guest: what changes',
      whyThisMatters: `Pregnant and post-natal guests appear on every spa column, and they are often carrying more discomfort than anyone else on it. A therapist who understands what has changed can adapt with calm confidence instead of vague anxiety, and that confidence is precisely what these guests - and the managers who assign these bookings - are looking for.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'From change to rule: why the adaptations make sense', steps: ['Circulation changes - so heat and position are managed with care', 'Ligaments soften - so stretching and pressure stay conservative', 'Posture shifts and loads the back and pelvis - so that is often where the treatment matters most', 'Later pregnancy makes lying flat unwise - so side-lying and semi-reclined positions take over', 'Clot risk is raised in pregnancy and after birth - so leg work stays light and flowing'], caption: 'Understanding the change behind each rule is what turns protocol into judgement.' },
      ],
      scenario: `A guest at thirty weeks apologises as she sits down, saying she knows she is probably a nuisance to treat and will understand if the massage is a token effort; she mentions an aching lower back and a previous spa where she nearly fainted lying flat. Everything in this lesson equips you to replace her apology with confidence: the faintness was positioning, not her body, and your venue's protocol exists for exactly this stage. What she needs from you is knowledge worn lightly - side-lying support, a comfortably warm room, light flowing leg work and real attention to the aching back - delivered within your training and protocol. If any part of her situation sits outside them, you adapt conservatively, defer or refer.`,
      activity: `Review your spa's consultation form and booking questions for pregnancy and recent birth. Check that they give every guest a private, dignified way to tell you what you need to know, and find out at what point your venue asks the question during booking. Note anything unclear and raise it with your manager.`,
      knowledgeCheck: [
        { q: 'In later pregnancy, side-lying and semi-reclined positions are preferred because...', options: ['They are quicker to set up', 'Guests always request them', 'Lying flat on the back can leave the guest faint, nauseous or breathless, so protocols move away from it', 'Face-down positions damage the couch'], answer: 2, why: 'The positioning rule follows the physical change: in later pregnancy, lying flat allows the uterus to press on a major blood vessel. Understanding why makes the adaptation confident rather than anxious.' },
        { q: 'The post-natal period is best understood as...', options: ['A distinct recovery stage, with persistent joint laxity, healing tissues and real physical strain, that shapes safe treatment for months', 'A return to normal once the baby is born', 'Only relevant if the guest mentions problems', 'Over by the time a guest can visit a spa'], answer: 0, why: 'Recovery, not rewind: laxity persists, the abdominal wall and pelvic floor are rebuilding, a caesarean is major surgery, and early parenthood adds genuine musculoskeletal strain. Adapt for the recovery; honour the exhaustion.' },
      ],
      keyTerms: [
      ...
      nextStep: `Walk through your spa's pregnancy treatment set-up - cushions, couch, positioning options - so the physical craft is familiar before a guest needs it.`,
    },
    {
      title: 'Contraindications, cautions and treatment adaptations',
      whyThisMatters: `Contraindication fluency is what venues, insurers and head therapists look for before they trust anyone with pregnancy bookings. Knowing the classic cautions cold, and your venue's exact protocol, is what turns a nerve-racking column into a confident one - and what keeps every guest safe while it does.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'Red flags: pause and hand over well', steps: ['A guest reports a red-flag symptom - severe headache, visual disturbance, sudden swelling, bleeding, or one-sided calf pain or heat', 'Pause the treatment calmly; keep her comfortable and accompanied', `Follow your venue's protocol`, 'Encourage urgent advice from her midwife, maternity unit or doctor', 'No diagnosis in either direction: no frightening speculation, no false reassurance'], caption: 'You are the professional who noticed, paused and handed over well - and that is exactly enough.' },
        { kind: 'image_placeholder', title: 'IMAGE: Supported side-lying set-up', description: `A photograph of your spa's own side-lying cushion arrangement helps therapists build the position quickly and consistently. Admin can upload via Academy Downloads.` },
      ],
      scenario: `A hot stone massage booked online slips past screening, and the guest's consultation form reveals she is twenty-four weeks pregnant. She has been looking forward to the stones for weeks, her back genuinely aches, and she offers to sign anything, mentioning a friend who had hot stones abroad while pregnant. The protocol is not yours to relax, and no signature changes that: heat treatments including hot stones are avoided in pregnancy under your venue's rules. The skill this lesson asks for is holding that line while saving the experience - offering the adapted treatment you are trained and insured to deliver, explained so warmly that the protocol reads as expertise rather than refusal. If your venue offers no suitable alternative you can deliver, you defer or refer rather than improvise.`,
      activity: `Find your venue's written pregnancy protocol and check the specifics against this lesson: the trimester policy, which treatments are offered from which week, the positioning standard, the product list approved for pregnancy, and the post-natal gateway. Write down anything the protocol leaves unanswered and ask your head therapist this week.`,
      knowledgeCheck: [
        { q: 'A pregnant guest asks for deep, specific work on her calves, where her legs feel heavy and achy. You should...', options: ['Work deeply, since she has asked for it', 'Keep leg work light and flowing per protocol, because clot risk is raised in pregnancy - and explain the adaptation warmly', 'Skip the legs entirely without explanation', 'Use deep pressure on one leg only, as a test'], answer: 1, why: 'Deep pressure on the calves is treated with particular caution in pregnancy and the weeks after birth because clot risk is raised. The adaptation, explained warmly, is the professional answer - guest preference does not change it.' },
        { q: 'A first-trimester guest arrives for a full body massage, and your venue restricts treatments in the first twelve weeks. The rule is...', options: ['Yours to relax for a clearly healthy guest', 'Negotiable if she signs a waiver', 'Only relevant to heat experiences', `The venue's to set and yours to follow exactly - offer what the protocol permits, or rebook warmly for the right stage`], answer: 3, why: `Trimester restrictions carry the venue's insurance and clinical advice behind them. A therapist who quietly overrides a protocol is working uninsured; a therapist who defers warmly, with an alternative where permitted, is doing the job.` },
        { q: 'A pregnant guest mentions one-sided calf pain and warmth. You should...', options: ['Pause, follow your protocol and encourage urgent medical advice - the area is never massaged', 'Massage the area gently to ease it', 'Reassure her that leg aches are normal in pregnancy', 'Continue the treatment but avoid that leg'], answer: 0, why: 'One-sided calf pain, heat, redness or swelling is a red flag that moves the situation out of spa territory entirely. Pause, hand over well, and never diagnose - in either the frightening or the reassuring direction.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Memorise the red-flag list until it is reflex - severe headache, visual disturbance, sudden swelling, bleeding, one-sided calf pain or heat - and know exactly whom you would tell first in your venue.',
    },
    {
      title: 'Consultation, communication and emotional care',
      whyThisMatters: `In this territory a single assumption can undo years of trust: the guest on your couch may be pregnant after loss, no longer pregnant, or struggling in ways no booking note shows. Guests remember exactly how these conversations felt, and the therapist who never assumes, and always follows the guest's lead, is the one they trust with their most vulnerable hours.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'The never-assume consultation', steps: [`No comments on any guest's body, ever - and no pregnancy talk within earshot of others`, 'A private, routine question: is there anything in your health, including pregnancy or recent birth, that should shape today?', 'She controls what she shares; a declination is noted and the protocol followed', 'Her language and tone set yours: mirror, and celebrate only when invited', 'Preferences and adaptations go on the record, so the next visit starts well'], caption: 'The finest emotional care in a spa is almost invisible: it is the absence of every wrong note.' },
      ],
      scenario: `A booking note reads: pregnancy massage, twenty weeks, gift from husband. In the privacy of the treatment room, your routine consultation question is met with a pause, and then the guest tells you she lost the baby three weeks ago and almost cancelled at the door, apologising for the awkwardness. Because you assumed nothing, no wrong note has been struck, and what remains is small, unforced kindness: no apology owed, choices offered instead of sympathy speeches, and an adapted treatment in place of the pregnancy protocol, within what your venue permits. Afterwards the record is quietly updated so no colleague ever repeats the booking note's assumption, and if she seems to be struggling, her midwife, GP or health visitor is the gentle signpost.`,
      activity: `Rehearse your consultation question aloud until it is one calm, routine sentence that never assumes: whether there is anything in her health, including pregnancy or recent birth, that should shape today's treatment. Then check how your spa's booking notes are updated after a consultation reveals they are out of date, and raise it if there is no clear process.`,
      knowledgeCheck: [
        { q: 'A guest looks visibly pregnant and is glowing. At reception, you should...', options: ['Congratulate her warmly', 'Ask when the baby is due', 'Mention the pregnancy menu she might enjoy', 'Say nothing about it - the private consultation gives her a dignified way to tell you what you need to know'], answer: 3, why: 'Never assume, never comment on a body, never raise pregnancy in front of others. The consultation form and a private conversation carry the load, and they protect the guests whose stories you cannot see.' },
        { q: 'A post-natal guest becomes tearful and says she has been feeling overwhelmed and not herself. Your role is to...', options: ['Offer your best advice on feeding and sleep routines', 'Tell her every new mother feels this way', 'Listen warmly without probing or advising, adapt the hour to what she needs, and gently signpost her midwife, GP or health visitor afterwards', 'Change the subject to keep the treatment relaxing'], answer: 2, why: `Warm, boundaried listening is the whole of your role: no probing, no interpreting, no advice. The signpost to her midwife, GP or health visitor, offered as care rather than dismissal, takes one sentence - and anything suggesting risk follows your venue's safeguarding protocol.` },
      ],
      keyTerms: [
      ...
      nextStep: 'At your next consultation with any guest, practise offering one extra choice - side, silence or conversation, anything left out - and notice how much safety it builds.',
    },
    {
      title: 'Scope of practice, consent, referral and accredited training',
      whyThisMatters: `Three authorities outrank any course: your venue's protocol, your insurer's requirements and the guest's own medical guidance, and knowing that is the single most protective habit in specialist care. Scope held gracefully keeps your insurance valid, your guests safe and your reputation clean - and it is exactly the judgement spas promote.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'Adapt, defer or refer: the professional triangle', steps: ['An uncertain moment arises in a pregnancy or post-natal booking', 'Small uncertainty, guest cleared for treatment? ADAPT conservatively, and say what you are doing and why', 'Bigger question - early pregnancy against a venue restriction, a scar not yet cleared, a review pending? DEFER warmly, with an alternative today where protocol permits', 'The matter belongs to someone else? REFER gracefully - senior therapist, reception, or her midwife or doctor', 'Whatever the move: record it'], caption: 'Knowing the three moves removes the panic from the decision.' },
      ],
      scenario: `Six weeks after a caesarean birth, a determined guest asks you directly for firm abdominal massage over and around her scar, having read online that massage helps scars; her postnatal check is booked for next week. She is articulate, paying, and expects a luxury spa to say yes. The triangle resolves it without drama: the abdominal request is deferred, because under your protocol work near a caesarean scar waits until it is healed and medically cleared, and her check next week is the natural gateway; today is adapted instead to the genuine strains of early parenthood, such as her neck, shoulders and back, within protocol; and the conversation is recorded in full. Delivered warmly and with a plan, scope reads as five-star expertise, not refusal.`,
      activity: `Ask your venue this week exactly what training and sign-off it requires before a therapist delivers pregnancy or post-natal treatments, and check what your own insurance says. If you are already cleared, confirm the boundaries of that clearance in writing; if you are not, find out which accredited qualification your venue recognises.`,
      knowledgeCheck: [
        { q: 'Awareness-level training in pregnancy care means...', options: ['You may deliver pregnancy massage once you feel confident', `It builds understanding, safe habits and communication skill - hands-on practice is governed by venue protocol, insurer requirements and the guest's medical guidance`, 'You can adapt any treatment without further sign-off', 'You may market yourself as a certified specialist'], answer: 1, why: 'The honest sentence at the heart of scope: this course makes you aware, it does not make you certified. The three authorities that govern hands-on practice outrank any course, including this one.' },
        { q: `A guest's midwife has set conditions on her spa treatment. Those conditions...`, options: ['Override everything else - the treatment follows them or does not happen', 'Are advisory only', `Can be relaxed with the guest's consent`, 'Apply only to heat experiences'], answer: 0, why: `The guest's own medical guidance sits above venue preference, guest enthusiasm and therapist confidence alike. If her healthcare team has set conditions, the treatment follows them or is deferred.` },
        { q: 'The record of a specialist consultation should include...', options: ['Only the treatment name and duration', 'Nothing sensitive, to protect privacy', 'The consultation, the stage of pregnancy or recovery, the adaptations and why, reported medical guidance, and anything the guest declined to share', 'Your private impressions of the guest'], answer: 2, why: 'A calm, contemporaneous record is both continuity of care and professional protection. Privacy is served by confidentiality of the record, never by leaving it empty.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Rehearse the referral sentence until it is natural: based on what you have told me, the safest and most enjoyable option today is this, and here is what I suggest for next time.',
    },
  ],
}

...
export const content: CourseContent = {
  ...
  references: [
    ...
    { label: `Your own spa's written protocols and insurance documents - the governing references for everything in this course` },
  ],
  ...
  lessons: [
    {
      title: 'Understanding cancer and its effect on the spa guest',
      whyThisMatters: `Guests living with and beyond cancer are part of every spa's guest book, whether or not the booking says so. For them, a therapist who understands calmly can turn an ordinary hour into a rare experience of being cared for as a person rather than a patient. For you, that steadiness is both a professional duty and one of the most valued skills a luxury spa can hire.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'From label to person: the awareness reframe', steps: ['A diagnosis appears on the consultation form', 'Receive it calmly - the word begins a conversation, it does not end the booking', 'Ask how the guest is affected today - never what the diagnosis means', `Check venue protocol and, where required, the guest's medical guidance`, 'Adapt conservatively within your training - or refer'], caption: 'The reframe this lesson teaches, as a sequence you can rehearse before a guest ever needs it.' },
      ],
      scenario: `A guest arrives for a back, neck and shoulder massage and has written a single word, radiotherapy, on her consultation form. She says brightly that she is absolutely fine, that treatment finished recently, and that she would rather not make a fuss. She moves stiffly, and you do not know what your venue's protocol asks for guests so recently out of treatment. Her cheerfulness is welcome, but it does not replace the protocol check, the present-tense questions about how she is affected today, or the conservative adaptations that follow. If the protocol or your training leaves any doubt, the answer is already written: adapt conservatively, or refer.`,
      activity: `Find and read your spa's written protocol for guests living with and beyond cancer. Note what it permits at your level of training, what requires medical confirmation, and who on the team holds accredited oncology touch certification. If you cannot find a written protocol, raise it with your manager this week: knowing where it lives, and what it says, is the first practical act of awareness.`,
      knowledgeCheck: [
        { q: `A guest writes 'chemotherapy' on her consultation form and nothing more. Your first professional move is to...`, options: ['Cancel the treatment, because chemotherapy rules out all spa treatments', 'Thank her calmly, ask how she is affected today, and check what your venue protocol requires', 'Ask what type of cancer she has so you can plan the treatment yourself', 'Proceed as normal so she does not feel singled out'], answer: 1, why: `The word on the form begins a conversation, not a refusal. Your role is the effects today, the venue protocol and, where required, medical guidance - never interpreting the diagnosis.` },
        { q: 'The old teaching that all massage must be refused to anyone with cancer is best described as...', options: ['Still the safest rule to follow', 'Correct for body treatments but not for facials', 'A current legal requirement in UK spas', 'Outdated - adapted touch within training, protocol and medical guidance is the modern professional standard'], answer: 3, why: `The blanket ban is outdated, but its replacement is not 'anything goes': it is adaptation inside a professional frame of training, venue protocol and the guest's medical guidance.` },
        { q: 'This course prepares you to...', options: ['Understand, adapt conservatively and refer - it is awareness-level and does not replace accredited oncology touch certification', 'Treat guests in active treatment once you have read it carefully', 'Advise guests on managing the side effects of their treatment', 'Decide for yourself which cautions still apply to each guest'], answer: 0, why: 'Awareness-level training makes you knowledgeable, calm and safe within your scope. Treating guests in active treatment belongs to accredited certification, venue protocol and, where required, medical confirmation.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Before your next shift, find out exactly where your spa keeps its protocol for guests affected by cancer, and read it from start to finish.',
    },
    {
      title: 'Contraindications, cautions and treatment adaptations',
      whyThisMatters: `Adaptation is where awareness becomes care a guest can actually feel. Therapists who can quietly re-engineer pressure, heat, products and positioning within protocol are the ones coordinators trust with the most sensitive bookings, and the guest experiences that skill as personalisation rather than caution.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'The adapt-or-refer decision', steps: ['Consultation reveals a treatment history, a device or an at-risk area', 'Check the venue protocol: what may be offered, by whom, with what confirmation', 'Inside protocol and your training? Adapt conservatively: pressure, heat, products, positioning, timing', 'Any element still uncertain? Choose the gentler option - or refer', `Record every adaptation on the guest's notes`], caption: 'The sequence never changes, whatever the treatment: protocol first, conservative adaptation second, referral whenever doubt remains.' },
      ],
      scenario: `A regular guest arrives for her usual firm full-body massage and mentions, while settling in, that she now has a port fitted and had surgery a few months ago, adding that she would still like proper pressure because light massage never feels worth the money to her. You can feel the pull to please a loyal guest. The lesson's answer is unchanged by her preference: the device area is never worked over, recent surgical sites are avoided, and deep pressure has no place on this booking. Your task is to explain the adapted plan so warmly that gentleness reads as expertise, and to check the protocol on anything you are not certain of before you begin. If any element still feels unclear, you refer rather than guess.`,
      activity: `Take your spa's treatment menu and mark every element that involves concentrated heat, deep pressure or strong products. Then check your venue's written protocol for how each is handled for guests affected by cancer treatment, and note anything the protocol does not answer so you can ask your senior therapist before the situation is live.`,
      knowledgeCheck: [
        { q: `A guest at risk of lymphoedema after lymph node removal asks for firm massage on the affected arm 'to help it drain'. You should...`, options: ['Agree, since firm work will help the drainage', 'Use moderate pressure as a compromise', 'Follow your protocol: the at-risk limb receives only the lightest touch or is left out entirely, explained warmly', 'Ask her to confirm the request in writing first'], answer: 2, why: `The lymphoedema risk can be lifelong, and how the limb is treated is a matter for your venue's protocol, not negotiation or instinct. Explaining the adaptation warmly keeps the guest cared for while keeping her safe.` },
        { q: 'A guest in active treatment asks to use the sauna before her massage. The professional response is to...', options: [`Follow your venue's policy on thermal facilities for these guests and, where it requires it, the guest's medical advice - not your own instinct in the moment`, 'Allow it if she promises to keep the visit short', 'Allow it, because the sauna is part of the spa day she paid for', 'Refuse, and cancel the massage as well to be safe'], answer: 0, why: 'Heat for guests in or recently out of active treatment is a decision for venue policy and medical guidance, because sensation and tolerance may be altered. Neither therapist instinct nor guest enthusiasm replaces that.' },
        { q: 'You have adapted a treatment for a guest recently out of treatment. Afterwards you should...', options: ['Keep the details to yourself for confidentiality', `Record every adaptation on the guest's notes so the next therapist begins where your care left off`, 'Mention her situation at handover so everyone on the team knows', 'Record anything only if something went wrong'], answer: 1, why: `Complete notes are continuity of care and professional protection at once. Confidentiality means sharing only what the treatment and records require - and the record itself is exactly that.` },
      ],
      keyTerms: [
      ...
      nextStep: `This week, read how your venue's protocol handles thermal facilities for guests in and recently out of treatment, so the answer is ready before a guest asks.`,
    },
    {
      title: 'Communication, consultation and emotional care',
      whyThisMatters: `The consultation can be the most exposed moment of a guest's visit, and how you receive a disclosure decides whether it was safe to make. Guests remember the therapist who was calm, warm and unremarkable about it at the hardest time of their lives, and they ask for her by name.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'The consultation conversation arc', steps: ['A private setting and a calm welcome', 'The disclosure is received with a steady thank you and no drama', 'Present-tense questions: how are you feeling today, which areas shall I avoid, what would make this hour comfortable?', 'The plan and its adaptations are said back to the guest', 'The closing promise: you can change your mind about anything, at any point'], caption: 'One arc, rehearsable in advance, that hands control to the guest and gathers exactly what your adaptations need.' },
      ],
      scenario: `Your guest disclosed her diagnosis briefly at consultation and made it clear she would rather not discuss it further, so you followed her lead into easy, ordinary conversation. Midway through the treatment she becomes quietly tearful and apologises for it. Nothing in this moment calls for advice or reassurance about her illness, and both would be outside your scope. What the lesson asks of you is stillness, a tissue, and her choice of whether to pause, talk or continue. Afterwards, nothing is shared with colleagues beyond her treatment notes.`,
      activity: `Practise the consultation aloud, ideally with a colleague playing the guest. Say the whole arc: the thank you, the present-tense questions, the adapted plan said back, and the promise that she can change her mind at any point. Rehearse until the words feel like yours, because a disclosure is the wrong moment to be searching for them.`,
      knowledgeCheck: [
        { q: 'A guest discloses her diagnosis at consultation and then chats happily about her garden for the rest of the hour. You should...', options: ['Gently return the conversation to her health so she feels heard', 'Ask how her treatment is going, to show you care', 'Stay silent for the rest of the treatment out of respect', 'Follow her lead completely - many guests come to the spa precisely to spend an hour not being a patient'], answer: 3, why: 'The guest sets the conversational register. Forcing solicitous talk on a guest who wanted ordinary warmth undoes the very normality she came for.' },
        { q: `A tearful guest asks: 'tell me honestly, do you think I will be all right?' The professional response is...`, options: [`'I am sure you will be fine - you seem so strong'`, 'Warm honesty about what is yours to give: you will keep her comfortable and safe today, and this hour is hers - the outlook is never yours to predict', 'To share the story of another guest who recovered well', 'To change the subject as quickly as possible'], answer: 1, why: 'False reassurance is not yours to give and can land painfully. The professional middle path is warm, steady honesty about what you can actually promise: comfort, safety and care today.' },
        { q: `What may be shared with colleagues about a guest's disclosure?`, options: ['Anything, as long as it stays within the team', 'Nothing at all, including treatment notes', 'Only what the treatment and her records require - never as conversation', 'A brief summary at the next team meeting'], answer: 2, why: 'Confidentiality is absolute: the disclosure lives on the secure record for professional use, and travels nowhere else - not the staff room, not the handover chat.' },
      ],
      keyTerms: [
      ...
      nextStep: 'The next time any guest shares something sensitive, practise the steady thank you and one present-tense question - the habit transfers directly to these consultations.',
    },
    {
      title: 'Scope of practice, consent, referral and accredited training',
      whyThisMatters: `Scope is what makes every other skill in this course safe to use, and it is the boundary insurers, venues and guests all rely on. A therapist who knows exactly what she can offer, and says so gracefully, is trusted with the most delicate bookings and with the training investment that follows.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'When you are unsure: the referral ladder', steps: ['A booking or question sits outside your certainty', 'Check the venue protocol first - it may already hold the answer', 'Still unsure? Ask your senior therapist or manager', 'The booking needs accredited certification? Route it to a certified colleague, per protocol', 'Medical confirmation required? Follow the venue process before any treatment', 'Offer what you safely can, warmly - and record everything'], caption: 'Referral is a ladder, not a leap: each rung is a smaller, safer question than guessing.' },
      ],
      scenario: `You are on an agency shift at an unfamiliar spa when reception passes you a booking for a guest who is midway through chemotherapy and hoping for a massage before a family event. You hold awareness-level training only, and you have not yet seen this venue's protocol. The professional sequence is exactly what this lesson teaches: ask for the protocol, tell the coordinator honestly what you are and are not certified for, and let the venue route the booking to a certified colleague if it holds one, with medical confirmation arranged as the protocol requires. Your part may end with offering a gentler alternative within your own scope, and offering it warmly is service, not failure.`,
      activity: `Write down, in two lists, what you are certain your training and insurance cover for guests affected by cancer, and what you are not certain of. Take the second list to your manager or insurer this week and turn every uncertainty into a written answer before a sensitive booking tests it.`,
      knowledgeCheck: [
        { q: `You notice an unusual mole on a guest's shoulder during a massage. You say...`, options: ['One calm sentence: you noticed a small area you were not sure about, and it may be worth showing her doctor - then you let it go', 'Nothing, because it is not your place to have seen it', `'I am sure it is nothing, but keep an eye on it'`, 'That it looks concerning and she should see a specialist urgently'], answer: 0, why: `Noticing and mentioning, once and calmly, is the whole of your role. Both reassurance and alarm are diagnoses in disguise, and neither is yours to give.` },
        { q: 'Before a therapist treats guests in active cancer treatment, many insurers require...', options: ['A signed waiver from the guest', 'Approval from the spa reception team', 'Accredited oncology touch certification - awareness-level training is not a substitute', 'Nothing, provided the therapist feels confident'], answer: 2, why: 'Accredited oncology touch programmes exist precisely for this work, and many insurers mandate them. Knowing what your venue and your own insurance hold is part of professional scope.' },
        { q: 'A sensitive booking sits outside your certainty and the protocol does not fully answer it. You should...', options: ['Proceed carefully and watch how the guest responds', 'Ask the guest what she thinks would be safe', 'Take the booking but shorten the treatment', `Adapt conservatively or refer - to your senior, the protocol's owner or the guest's medical team - and never guess`], answer: 3, why: 'When the answer is genuinely unclear, the default never changes: adapt conservatively or refer. A guest is never worse off for a gentler treatment or a well-made referral; the reverse is not true.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Ask your manager this week which accredited oncology touch programmes your venue and its insurer recognise, and what the path to certification would look like for you.',
    },
  ],
}

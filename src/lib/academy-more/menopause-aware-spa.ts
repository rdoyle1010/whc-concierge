...
export const content: CourseContent = {
  ...
  lessons: [
    {
      title: 'Understanding Menopause and the Spa Guest',
      whyThisMatters: `Midlife women are the backbone of many luxury spa guest books, and a meaningful share of them are moving through perimenopause or menopause right now, whether or not they ever mention it. A therapist who understands this life stage delivers visibly kinder, safer treatments to a large part of every column, and that awareness costs nothing but knowledge and attention.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'Awareness without assumption', steps: ['A guest mentions broken sleep, aches or running warm', 'Hold the awareness privately - never name or diagnose what it might be', 'Adapt for what she has actually told you: temperature, pace, pressure, products', 'If she wonders aloud what her symptoms mean, signpost kindly to her GP or a menopause specialist', 'Record what shaped the treatment, in her own words'], caption: `What this lesson's knowledge is for: better adaptations, never friendly guesswork.` },
      ],
      scenario: `A regular guest in her forties arrives unusually flat, mentioning weeks of broken sleep, aching shoulders and a feeling of not being herself, and she has booked her usual treatment with the full heated couch and blanket wrap. You privately suspect the picture fits perimenopause and feel the kind impulse to say so, as reassurance that nothing is wrong. The lesson holds you back: naming it would be diagnosis, however friendly, and it could be wrong. Instead you adapt to what she has told you - a lighter layer offered, a cooler room available, a slower pace for the exhaustion - and if she asks what you think is happening, her GP is the right person for that conversation.`,
      activity: `Review your spa's consultation form with this lesson in mind. Check whether it asks about temperature comfort, sleep and skin changes in neutral language that any guest can answer, and note any question that presumes or would force a disclosure. Share what you find with whoever owns the form.`,
      knowledgeCheck: [
        { q: 'For a spa therapist, the correct working understanding of menopause is...', options: [`An illness requiring a doctor's note before any treatment`, 'A natural life stage with wide-ranging effects, experienced differently by every guest', 'A condition only relevant to guests over sixty', 'Something a therapist can reliably identify from a pattern of symptoms'], answer: 1, why: 'Menopause is a life stage, not an illness, and every guest experiences it differently - which is why the professional stance is awareness, never assumption or identification.' },
        { q: 'A guest wonders aloud whether her broken sleep and flushes mean she is menopausal. You should...', options: ['Tell her the pattern certainly sounds menopausal', 'Reassure her it is probably just stress', 'Say kindly that her GP or a menopause specialist is the right person to explore that with, while you make her comfortable today', 'Suggest she research the symptoms online first'], answer: 2, why: 'Even friendly guesswork is diagnosis, and it can be wrong in both directions. Signposting to the right professional, while caring for her today, is the complete and correct answer.' },
      ],
      keyTerms: [
      ...
      nextStep: 'On your next few consultations, notice how naturally your comfort questions - temperature, sleep, anything she would like known - create openings without presuming anything.',
    },
    {
      title: 'Contraindications, Cautions and Treatment Adaptations',
      whyThisMatters: `Menopause is not a contraindication, but the cautions that can travel with it are exactly where guests feel the difference between a thoughtless treatment and a considered one. Confident, conservative adaptation is what separates a safe pair of hands from a liability, and managers and insurers both notice which one you are.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'When a hot flush arrives mid-treatment', steps: ['Pause calmly - no drama, no alarm', 'Lighten or lift the covers', 'Offer water and a cool cloth', 'Wait, with complete composure, for as long as she needs', 'Continue when she is ready, without comment'], caption: 'Your composure is the treatment in that moment.' },
      ],
      scenario: `A guest books your signature hot stone massage and notes recent night sweats on her form, mentioning in conversation that heat sometimes arrives out of nowhere and floors her. She is visibly hoping you will not cancel the treatment she has looked forward to for weeks. The judgement this lesson teaches is neither cancellation nor a cheerful carry-on: within your training and your venue's protocol, the treatment can often proceed with shared control - lighter draping, a cooler room, temperatures checked as your training requires, water in reach and an agreed pause signal. If anything about her situation sits beyond your training or the protocol, the default is unchanged: adapt conservatively or refer.`,
      activity: `List which of your spa's treatments involve sustained heat - heated couches, wraps, stones, thermal facilities - and find what your venue's protocol says about each for heat-sensitive guests. Then rehearse offering the choices aloud: a lighter blanket, a cooler room, water in reach, an agreed signal to pause.`,
      knowledgeCheck: [
        { q: 'A guest discloses osteoporosis on her consultation form. The professional adaptation is...', options: ['Deep pressure, to stimulate the bones', 'Declining all treatments permanently', 'Carrying on unchanged, since massage does not affect bone', 'Conservative pressure with no deep or forceful work, in line with your training and venue protocol'], answer: 3, why: `A disclosed bone-density condition calls for the conservative version of the treatment, delivered confidently - lighter pressure, no deep or forceful techniques - with the venue protocol and any medical guidance leading.` },
        { q: `A guest's consultation form lists hormone replacement therapy among her medication. You should...`, options: ['Record it and never comment on or advise about it', 'Ask how well it is working for her', 'Suggest a supplement from the retail shelf that other guests like', 'Adjust the treatment based on your own view of HRT'], answer: 0, why: 'Medication is noted on the record and left entirely alone. You are adapting a treatment, not reviewing a prescription - and advice in either direction is outside your scope.' },
        { q: 'An uncertain moment arises mid-treatment and neither your training nor the protocol gives you a clear answer. You should...', options: ['Trust your instinct and continue', 'Ask the guest to make the clinical call', 'Choose the unambiguously safe version - lighter, cooler, gentler - or pause and consult your senior', 'Finish quickly and make a note afterwards'], answer: 2, why: 'The conservative default is the whole discipline: a gentler treatment delivered with confidence is never a failure, and a senior colleague or the protocol is always the right next step when doubt remains.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Before your next heat-based treatment, decide exactly how you would pause it for a flush - covers, water, words - so the calm is ready in advance.',
    },
    {
      title: 'Consultation, Communication and Emotional Care',
      whyThisMatters: `Menopause is still a subject many guests have never discussed outside their own home, and your consultation may be the first place one is gently invited to. The therapist who can open that door without pushing through it earns disclosures, rebookings and requests by name - and the guest earns an hour of feeling genuinely understood.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'The disclosure arc: opening, receiving, caring', steps: ['Open neutrally: temperature comfort, sleep, skin, anything she would like known', 'She chooses what to share - much, little or nothing', 'Receive it calmly and thank her: it helps you tailor today', 'Turn it straight into practical care: layers, temperature, pressure, pace', 'Guard it absolutely: the record, and nowhere else'], caption: 'The invitation is an open door, never a push - and how you receive a disclosure decides whether it was safe to make.' },
      ],
      scenario: `A self-contained guest answers your medical questions in monosyllables, then, at your quiet question about sleep, suddenly shares that the flushes are constant, that she is menopausal and finds the whole subject mortifying, and that her doctor has mentioned HRT - what do you think she should do? Two doors have opened at once: a disclosure to receive and a question that crosses the scope line. The lesson's shape carries you through both: receive the disclosure calmly and turn it into practical adaptations, then hold the boundary kindly - it is a completely reasonable question, it sits beyond what you are qualified to advise on, and her GP or a menopause specialist is exactly the right person for it. Then bring her back to the care you can give today.`,
      activity: `Practise the warmth-boundary-redirection-care response aloud until it is one graceful line: acknowledge the question, state simply that it is outside what you are qualified to advise on, point to the GP or a menopause specialist, and return to today's treatment. Say it until it sounds like kindness rather than a script.`,
      knowledgeCheck: [
        { q: 'The professional way to invite a menopause-related disclosure is to...', options: ['Ask directly whether the guest is menopausal, to save time', 'Ask neutral comfort questions - temperature, sleep, skin, anything she would like known - and let her choose what to share', 'Wait for her to raise it and never ask anything at all', 'Raise it tactfully at reception while she checks in'], answer: 1, why: 'Direct questions presume, can land as a comment on her age, and can simply be wrong. Neutral openings hand the guest full control of what she shares, and privacy is non-negotiable.' },
        { q: `A guest jokes warmly about her 'personal tropical moments' during a flush. You may...`, options: ['Join in with a joke of your own to put her at ease', 'Share what another guest calls hers', 'Gently correct her terminology', 'Stay warm and matter-of-fact, mirroring her ease without joking yourself'], answer: 3, why: 'She may joke; you may not. Mirroring her language and lightness while staying warmly professional keeps her in control of how the subject is handled.' },
      ],
      keyTerms: [
      ...
      nextStep: `Reread your last few consultation records and check they would let a colleague continue each guest's care seamlessly - in the guest's own words, with the adaptations noted.`,
    },
    {
      title: 'Scope of Practice, Consent and Referral',
      whyThisMatters: `The boundary between awareness and accredited training is where guest safety, your insurance and your career all meet. Referring well, warmly and without alarm, is a five-star skill in itself - and knowing exactly when it is required is what makes you trustworthy with the most delicate bookings.`,
      objectives: [
      ...
      visuals: [
        { kind: 'flow', title: 'The scope check before a sensitive booking', steps: [`The guest's situation involves current medical treatment or an uncertain condition`, 'Check the venue protocol: what does it require for this guest?', 'Check your own certification and insurance: does this booking need accredited training you do not hold?', 'If it does, route the booking to a certified colleague or accredited venue, warmly and per protocol', 'Offer what you safely can today, and record everything'], caption: `Three authorities frame every sensitive booking: venue protocol, insurance requirements and the guest's own medical guidance.` },
      ],
      scenario: `A guest using a gift voucher notes hot flushes and poor sleep on her form, and mentions matter-of-factly that her menopause arrived early, brought on by the chemotherapy she is currently having, adding that she would hate any fuss. In one sentence the booking has moved from menopause awareness into oncology territory, and the rules change completely. Your venue's protocol and many insurers require accredited oncology-touch certification before guests in active treatment can be treated, so improvising a gentler massage and hoping is not an option. The professional path is warm and specific: thank her, explain without alarm that she deserves a therapist with dedicated accredited training, and work with your manager to route the booking to a certified colleague, with her voucher honoured and the record updated.`,
      activity: `Find out this week which of your colleagues, if any, hold accredited oncology-touch certification, what your venue's protocol says about guests in active cancer treatment, and what your own insurance requires. Write the answers where you can find them at speed - mid-consultation is too late to start looking.`,
      knowledgeCheck: [
        { q: 'A guest in active cancer treatment, whose menopause was induced by it, books a massage with you. You hold awareness-level training only. The correct move is to...', options: ['Follow venue protocol and route the booking to a therapist with accredited oncology-touch certification, warmly and without alarm', 'Proceed with lighter pressure, since menopause is not a contraindication', 'Decline and suggest she tries another spa', 'Ask her to sign a waiver first'], answer: 0, why: 'The moment active cancer treatment enters the picture, the booking belongs to accredited certification and venue protocol, not to improvised gentleness. Referring warmly is the care, not a failure of it.' },
        { q: 'You may honestly tell a guest that a massage is deeply relaxing and that many guests sleep better after one. What may you never do?', options: ['Mention sleep at all', 'Promise the treatment will fix her insomnia or relieve a medical symptom', 'Offer water after the treatment', 'Note her sleep concerns on the record'], answer: 1, why: 'The line between honest comfort and medical claim is the line between a professional and a liability. Warm, truthful description is yours; promised outcomes are not.' },
        { q: 'Consent in specialist care is best understood as...', options: ['A signature collected at reception', 'Something needed only for new guests', 'A continuing conversation: the plan explained and agreed before, check-ins and pause signals honoured during, and everything recorded after', 'A formality the venue handles for you'], answer: 2, why: 'A guest who feels able to change her mind mid-treatment is a guest who has genuinely consented - and the record afterwards is what completes the picture and protects everyone.' },
      ],
      keyTerms: [
      ...
      nextStep: 'Rehearse the referral sentence aloud until it feels like service: what you can offer today, and who can offer more.',
    },
  ],
}

const STYLES: Record<string, string> = {
  ...
  intermediate: 'text-[10px] font-medium px-2 py-0.5 rounded-full bg-[#e0dad2] text-ink',
...
export default function ProficiencyBadge({ level }: { level: string }) {
  ...
  return (
    <span className={STYLES[mapped] || STYLES.beginner} style={mapped === 'master' ? { backgroundColor: '#57534e' } : undefined}>

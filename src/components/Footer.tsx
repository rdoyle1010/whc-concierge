...
export default function Footer({ siteContent }: { siteContent?: WebsiteContent }) {
  ...
  return <>
    <section className="bg-white border-t border-[#e5e5e5] overflow-hidden" aria-label="Spa Platform hospitality photography">
      ...
      {newsletterState === 'success' ? (
        ...
        <form onSubmit={subscribeToNewsletter} className="mt-3">
          <div className="flex gap-2">
            ...
            />
            <button type="submit" disabled={newsletterState === 'sending'} className="shrink-0 rounded-lg bg-white px-4 py-2.5 text-[12px] font-semibold text-[#111111] hover:bg-white/85 transition-colors disabled:opacity-60">

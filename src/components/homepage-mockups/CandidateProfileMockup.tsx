...
export default function CandidateProfileMockup() {
  return (
    <div className="dashboard-card relative mx-auto w-full max-w-sm bg-white p-5">
      ...
      <div className="grid grid-cols-3 gap-2 border-t border-[#e3e7eb] pt-3">
        <button type="button" className="flex items-center justify-center gap-1 rounded-lg bg-[#f5f6f8] py-2 text-xs text-muted"><X size={13} />Pass</button>
        <button type="button" className="flex items-center justify-center gap-1 rounded-lg bg-[#f5f6f8] py-2 text-xs text-secondary"><Star size={13} />Save</button>

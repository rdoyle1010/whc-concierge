...
export default function RoleListingMockup() {
  return (
    <div className="mx-auto w-full max-w-sm overflow-hidden rounded-3xl border border-border bg-white shadow-[0_18px_55px_rgba(28,28,28,.08)]">
      <div className="relative min-h-[170px] overflow-hidden bg-[#222321]">
      ...
      <div className="p-5">
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <div className="shrink-0 rounded-2xl border border-[#dcd4c8] bg-[#ede8df] px-3 py-2 text-center">
        ...
        <div className="mb-4 rounded-2xl border border-[#dcd4c8] bg-[#ede8df] p-4">
          <p className="mb-1 text-[9px] font-semibold uppercase tracking-[.14em] text-[#222321]">Why this role is showing</p>

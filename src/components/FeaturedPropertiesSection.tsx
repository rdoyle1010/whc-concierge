        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {data.map((property: any) => {
              ...
              return (
                <Link key={property.id} href={`/properties/${property.id}`} className="group overflow-hidden rounded-2xl border border-[#dcd4c8] bg-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
                  <div className="relative h-36 overflow-hidden bg-[#e3dcd1]">
                    ...
                    <span className="absolute left-4 top-4 inline-flex items-center gap-1 rounded-full bg-[#222321] px-3 py-1.5 text-[9px] font-semibold uppercase tracking-[0.12em] text-white"><Star size={10} fill="currentColor" /> Featured</span>
                  </div>
                  <div className="p-5">
                    <h3 className="text-[16px] font-semibold text-[#222321]">{name}</h3>

    ...
    <section className="dashboard-card mb-7">
      ...
      <div className="mt-5 space-y-4">
        {placements.map(placement => (
          <div key={placement.applicationId} className="rounded-2xl border border-[#e0dad2] bg-white p-5">

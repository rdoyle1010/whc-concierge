    ...
    <section className="dashboard-card mb-7">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-[12px] leading-5 text-muted">Completed hires can be reviewed by both sides, and you can separately tell us how the Talent House Collective experience worked for you.</p>
        </div>
      </div>

      <div className="mt-5 space-y-4">
        {placements.map(placement => (
          <div key={placement.applicationId} className="rounded-2xl border border-[#dcd4c8] bg-white p-5">

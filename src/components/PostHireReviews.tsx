    ...
    <section className="dashboard-card mb-7">
      ...
      <div className="mt-5 space-y-4">
        {placements.map(placement => (
          <div key={placement.applicationId} className="rounded-2xl border border-[#dddddd] bg-white p-5">

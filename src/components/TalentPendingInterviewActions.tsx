            ...
            return (
              <div key={interview.id} className="rounded-2xl border border-[#ded6c7] bg-[#fcfbf8] p-5">
                ...
                <div className="mt-4 flex items-center gap-2 rounded-xl bg-white px-3 py-2 text-[12px] text-secondary">
                  <CalendarDays size={14} className="text-[#10283b]" />
                ...
                <div className="mt-4">
                  <label htmlFor={`note-${interview.id}`} className="mb-2 flex items-center gap-2 text-[11px] font-semibold text-ink">
                    <MessageSquare size={13} className="text-[#10283b]" />2. Add a note to the property <span className="font-normal text-muted">(optional)</span>
                  </label>
                  <textarea
                ...
                <div className="mt-4 border-t border-[#e8e0d2] pt-4">
                  ...
                  <button
                    ...
                    className="mt-2 block text-[11px] font-semibold text-[#10283b] underline disabled:opacity-40 sm:ml-3 sm:mt-0 sm:inline-block"
                  >

...
export default function NewsletterSignupBar() {
  ...
  return <aside className="fixed inset-x-3 bottom-3 z-[70] mx-auto max-w-5xl rounded-2xl border border-[#e3e7eb] bg-white shadow-[0_18px_55px_rgba(7,29,45,.18)] md:inset-x-6" aria-label="Newsletter signup">
    <div className="relative grid gap-5 px-5 py-5 md:grid-cols-[1fr_auto] md:items-center md:px-7">
      <button type="button" onClick={dismiss} aria-label="Close newsletter signup" className="absolute right-3 top-3 rounded-full p-2 text-[#6b7580] hover:bg-[#f5f6f8] hover:text-[#10283b]"><X size={16}/></button>
      <div className="min-w-0 pr-8 md:pr-0">
        ...
        <p className="mt-2 text-[10px] leading-4 text-[#6b7580]">Double opt-in: we email you once to confirm. You can unsubscribe at any time. See our <a href="/privacy" className="underline">Privacy Policy</a>.</p>
      </div>

  ...
  return (
    <div className="dashboard-card">
      <div className="mb-5 flex items-start gap-3">
        <div className="flex h-10 w-10 items-center justify-center bg-[#f1f1f1] text-[#1c1c1c]"><Trash2 size={18} /></div>
        <div>
      ...
      {message && <div className="mb-4 border border-border bg-[#f1f1f1] px-4 py-3 text-[12px] text-secondary">{message}</div>}
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="mt-4 border-t border-border pt-4">
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#6b6b6b]">Never swept</p>

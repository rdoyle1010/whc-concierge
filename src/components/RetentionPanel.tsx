  ...
  return (
    <div className="dashboard-card">
      <div className="mb-5 flex items-start gap-3">
        <div className="flex h-10 w-10 items-center justify-center bg-[#ede8df] text-[#222321]"><Trash2 size={18} /></div>
        <div>
      ...
      {message && <div className="mb-4 border border-border bg-[#ede8df] px-4 py-3 text-[12px] text-secondary">{message}</div>}
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="mt-4 border-t border-border pt-4">
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#6e6a60]">Never swept</p>

    ...
    return (
      <div ref={rootRef} className="relative">
        <button
          ...
          className={`flex h-9 w-9 items-center justify-center transition-colors ${dark ? 'text-white/70 hover:text-white' : 'border border-border bg-white text-secondary hover:border-[#6e6a60] hover:text-ink'}`}
        >
          <Search size={16} />
        </button>
      </div>

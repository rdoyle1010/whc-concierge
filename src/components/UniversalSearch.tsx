...
export default function UniversalSearch({ variant, onNavigate }: { variant: 'navbar' | 'dashboard'; onNavigate?: () => void }) {
  ...
  return (
    <div ref={rootRef} className="relative max-lg:static">
      <div className="max-lg:fixed max-lg:inset-x-0 max-lg:top-0 max-lg:z-[80] max-lg:border-b max-lg:border-border max-lg:bg-white max-lg:p-3 max-lg:shadow-[0_18px_48px_rgba(5,29,46,.14)]">

...
export default function PrivacyPreferences() {
  ...
  return <div className="space-y-6">
    ...
    <section className="dashboard-card bg-[#f1f1f1]">
...
function Status({ value }: { value: Preferences['marketing_email_status'] }) {
  const labels: Record<string, [string, string]> = { confirmed: ['Confirmed', 'text-green-700 bg-green-50'], pending: ['Awaiting confirmation', 'text-amber-700 bg-amber-50'], unsubscribed: ['Unsubscribed', 'text-[#555555] bg-[#f1f1f1]'], never: ['Off', 'text-[#555555] bg-[#f1f1f1]'] }

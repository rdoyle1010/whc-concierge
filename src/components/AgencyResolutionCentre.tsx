...
export default function AgencyResolutionCentre({ role }: { role: 'talent'|'employer' }) {
  ...
  return <div className="space-y-7">
    ...
    <div className="dashboard-card">
      <div className="flex gap-3 items-start"><AlertTriangle size={20} className="text-accent mt-0.5"/><div><h2 className="font-serif text-xl text-ink">Shift Resolution Centre</h2><p className="text-sm text-gray-500 mt-1">{role === 'talent' ? 'Use this if a property changes or ends your shift, you work extra hours, or you are owed commission, service charge, expenses or other money. You can also report a property conduct or working-conditions concern.' : 'Use this for attendance, late arrival, early departure, cancellations, changed hours, payment adjustments or conduct concerns. Opening a case places the professional payout on hold until it is reviewed.'}</p></div></div>
    </div>

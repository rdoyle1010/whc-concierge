...
const styles = StyleSheet.create({
  scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:64,paddingBottom:110},center:{flex:1,alignItems:'center',justifyContent:'center',padding:28,backgroundColor:'#fff'},back:{color:'#66747c',fontSize:13,marginBottom:34},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:2.1,marginBottom:10},title:{color:'#0b2f4d',fontSize:30,lineHeight:36,fontWeight:'500'},intro:{color:'#66747c',fontSize:14,lineHeight:21,marginTop:10,marginBottom:24},card:{borderWidth:1,borderColor:'#dce3e7',padding:18},cardTitle:{color:'#173246',fontSize:18,fontWeight:'600'},meta:{color:'#66747c',fontSize:11,lineHeight:17,marginTop:6,marginBottom:14},row:{flexDirection:'row',justifyContent:'space-between',gap:14,paddingVertical:10,borderTopWidth:1,borderTopColor:'#edf1f3'},label:{color:'#66747c',fontSize:11,flex:1},value:{color:'#173246',fontSize:11,fontWeight:'600'},totalRow:{marginTop:3},totalLabel:{color:'#0b2f4d',fontSize:13,fontWeight:'700'},totalValue:{color:'#0b2f4d',fontSize:16,fontWeight:'700'},primary:{backgroundColor:'#0b2f4d',paddingVertical:16,alignItems:'center',marginTop:20},primaryText:{color:'#fff',fontSize:11,fontWeight:'700'},disabled:{opacity:.45},help:{color:'#71808a',fontSize:10,lineHeight:16,marginTop:10},confirmed:{backgroundColor:'#eef5f0',padding:16,marginTop:18},confirmedTitle:{color:'#456655',fontSize:13,fontWeight:'700'},notice:{backgroundColor:'#f4f7f8',padding:16,marginTop:18},noticeTitle:{color:'#173246',fontSize:13,fontWeight:'600'},refresh:{color:'#0b2f4d',fontSize:10,fontWeight:'700',marginTop:18},error:{color:'#9b2c2c',fontSize:11,lineHeight:17,marginTop:16}
})

...
const styles=StyleSheet.create({scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:40,paddingBottom:110},back:{color:'#66747c',fontSize:13,marginBottom:30},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:2.1,marginBottom:10},title:{color:'#0b2f4d',fontSize:31,lineHeight:37,fontWeight:'500'},intro:{color:'#66747c',fontSize:14,lineHeight:21,marginTop:10,marginBottom:20},banner:{backgroundColor:'#0b2f4d',padding:18,marginBottom:14},bannerTitle:{color:'#fff',fontSize:14,fontWeight:'600'},bannerCopy:{color:'#d6e0e5',fontSize:11,lineHeight:17,marginTop:5},step:{flexDirection:'row',borderBottomWidth:1,borderBottomColor:'#e4e9ec',paddingVertical:18,gap:14},number:{color:'#9aa7af',fontSize:10,letterSpacing:1.4,width:26},stepBody:{flex:1},stepTitle:{color:'#173246',fontSize:16,fontWeight:'600'},stepCopy:{color:'#71808a',fontSize:12,lineHeight:18,marginTop:6},action:{color:'#0b2f4d',fontSize:11,fontWeight:'700',marginTop:10},footer:{backgroundColor:'#f4f7f8',padding:18,marginTop:22},footerTitle:{color:'#173246',fontSize:13,fontWeight:'600'},footerCopy:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:5}})

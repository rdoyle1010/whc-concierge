  ...
  async function save() {
    ...
    try {
      const payload = {
        ...
        star_rating: profile.star_rating || '', tagline: profile.tagline || '', about_text: profile.about_text || '',

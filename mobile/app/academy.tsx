...
const styles=StyleSheet.create({scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:64,paddingBottom:50},back:{color:'#66747c',fontSize:13,marginBottom:34},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:2.1,marginBottom:10},title:{color:'#0b2f4d',fontSize:31,lineHeight:37,fontWeight:'500'},intro:{color:'#66747c',fontSize:14,lineHeight:21,marginTop:10,marginBottom:22},member:{backgroundColor:'#f4f7f8',padding:16,marginBottom:12},memberTitle:{color:'#173246',fontSize:13,fontWeight:'700'},memberCopy:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:4},success:{borderWidth:1,borderColor:'#d6e4dd',padding:16,marginBottom:12},successTitle:{color:'#254a39',fontSize:13,fontWeight:'700'},successCopy:{color:'#5f756a',fontSize:11,lineHeight:17,marginTop:4},error:{color:'#9b2c2c',fontSize:12,marginBottom:16},bundle:{backgroundColor:'#0b2f4d',padding:20,marginBottom:26},bundleEyebrow:{color:'#dfe7eb',fontSize:9,letterSpacing:1.8},bundleTitle:{color:'#fff',fontSize:21,fontWeight:'600',marginTop:6},bundleCopy:{color:'#c8d2d7',fontSize:12,lineHeight:18,marginTop:6,marginBottom:16},section:{marginBottom:26,gap:10},sectionTitle:{color:'#71808a',fontSize:9,letterSpacing:1.7,textTransform:'uppercase',marginBottom:2},card:{borderWidth:1,borderColor:'#dce3e7',padding:18,backgroundColor:'#fff'},doneCard:{borderColor:'#c9ddd3'},cardTop:{flexDirection:'row',gap:10,justifyContent:'space-between'},courseTitle:{color:'#173246',fontSize:17,fontWeight:'600'},tagline:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:4},certified:{color:'#315846',fontSize:8,letterSpacing:1.1},owned:{color:'#0b2f4d',fontSize:8,letterSpacing:1.1},meta:{color:'#71808a',fontSize:10,marginTop:12,marginBottom:14},primary:{backgroundColor:'#0b2f4d',paddingVertical:14,alignItems:'center'},primaryText:{color:'#fff',fontSize:11,fontWeight:'700'},secondary:{borderWidth:1,borderColor:'#0b2f4d',paddingVertical:13,alignItems:'center'},secondaryText:{color:'#0b2f4d',fontSize:11,fontWeight:'700'},foot:{color:'#839097',fontSize:10,lineHeight:16,marginTop:4}})

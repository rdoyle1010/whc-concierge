...
const styles=StyleSheet.create({scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:42,paddingBottom:100},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:2.1,marginBottom:10},title:{color:'#0b2f4d',fontSize:31,lineHeight:37,fontWeight:'500'},tabs:{flexDirection:'row',borderWidth:1,borderColor:'#d7e0e4',marginTop:20},tab:{flex:1,paddingVertical:12,alignItems:'center'},tabActive:{backgroundColor:'#0b2f4d'},tabText:{color:'#66747c',fontSize:10,fontWeight:'700'},tabActiveText:{color:'#fff'},intro:{color:'#66747c',fontSize:14,lineHeight:21,marginTop:14,marginBottom:26},list:{gap:12},card:{borderWidth:1,borderColor:'#dce3e7',padding:19},topRow:{flexDirection:'row',justifyContent:'space-between',gap:10},status:{color:'#0b2f4d',fontSize:9,letterSpacing:1.3,textTransform:'uppercase'},hiredStatus:{color:'#456655',fontSize:9,fontWeight:'800',letterSpacing:1.3},score:{color:'#173246',fontSize:11,fontWeight:'600'},cardTitle:{color:'#173246',fontSize:18,fontWeight:'600',marginTop:9},meta:{color:'#66747c',fontSize:12,lineHeight:18,marginTop:7},date:{color:'#8a969d',fontSize:10,marginTop:7},withdraw:{color:'#7a4a4a',fontSize:11,marginTop:13},manage:{borderTopWidth:1,borderTopColor:'#edf1f3',marginTop:16,paddingTop:14},manageText:{color:'#0b2f4d',fontSize:11,fontWeight:'700'},reopen:{color:'#0b2f4d',fontSize:11,fontWeight:'700',marginTop:12},history:{marginTop:14,borderTopWidth:1,borderTopColor:'#edf1f3',paddingTop:12,gap:10},block:{backgroundColor:'#f4f7f8',padding:13},blockLabel:{fontSize:8,letterSpacing:1.3,color:'#0b2f4d',fontWeight:'700'},blockCopy:{fontSize:11,lineHeight:18,color:'#5f6e77',marginTop:6},line:{paddingVertical:8,borderBottomWidth:1,borderBottomColor:'#e8ecee'},lineTitle:{color:'#173246',fontSize:11,fontWeight:'600'},lineCopy:{color:'#71808a',fontSize:10,lineHeight:16,marginTop:3},empty:{backgroundColor:'#f4f7f8',padding:20},emptyTitle:{color:'#173246',fontSize:15,fontWeight:'600'},emptyCopy:{color:'#71808a',fontSize:12,lineHeight:18,marginTop:6},error:{color:'#9b2c2c',fontSize:12,marginBottom:18}})

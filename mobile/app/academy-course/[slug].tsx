...
const styles=StyleSheet.create({scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:64,paddingBottom:50},pageStatic:{flex:1,backgroundColor:'#fff',paddingHorizontal:22,paddingTop:64},center:{flex:1,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',padding:24},back:{color:'#66747c',fontSize:13,marginBottom:30},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:1.7,marginBottom:10},title:{color:'#0b2f4d',fontSize:30,lineHeight:36,fontWeight:'500'},intro:{color:'#66747c',fontSize:13,lineHeight:20,marginTop:8,marginBottom:20},progressCard:{backgroundColor:'#f4f7f8',padding:15,marginBottom:16},progressText:{color:'#173246',fontSize:11,fontWeight:'600'},track:{height:5,backgroundColor:'#dce4e8',marginTop:9},fill:{height:5,backgroundColor:'#0b2f4d'},certificate:{borderWidth:1,borderColor:'#cfe0d7',padding:17,marginBottom:16},certificateTitle:{color:'#315846',fontSize:14,fontWeight:'700'},certificateCode:{color:'#173246',fontSize:19,fontWeight:'600',letterSpacing:1.2,marginTop:6},certificateCopy:{color:'#65766e',fontSize:11,lineHeight:17,marginTop:6},tabs:{gap:7,paddingBottom:16},tab:{minWidth:42,paddingHorizontal:12,paddingVertical:10,borderWidth:1,borderColor:'#dce3e7',alignItems:'center'},tabActive:{backgroundColor:'#0b2f4d',borderColor:'#0b2f4d'},tabDisabled:{opacity:.35},tabText:{color:'#526976',fontSize:10,fontWeight:'600'},tabTextActive:{color:'#fff'},card:{borderWidth:1,borderColor:'#dce3e7',padding:19,marginBottom:18},moduleLabel:{color:'#71808a',fontSize:8,letterSpacing:1.7,marginBottom:7},sectionTitle:{color:'#173246',fontSize:20,fontWeight:'600',marginBottom:12},body:{color:'#526976',fontSize:13,lineHeight:22},primary:{backgroundColor:'#0b2f4d',paddingVertical:14,alignItems:'center',marginTop:18},primaryText:{color:'#fff',fontSize:11,fontWeight:'700'},question:{marginBottom:20},questionText:{color:'#173246',fontSize:13,lineHeight:19,fontWeight:'600',marginBottom:10},option:{borderWidth:1,borderColor:'#dce3e7',padding:12,marginBottom:7},optionSelected:{backgroundColor:'#0b2f4d',borderColor:'#0b2f4d'},optionText:{color:'#526976',fontSize:11,lineHeight:17},optionTextSelected:{color:'#fff'},score:{color:'#71808a',fontSize:11,textAlign:'center',marginTop:10},error:{color:'#9b2c2c',fontSize:12,marginBottom:14}})

...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:'#fff',justifyContent:'center'},wrap:{paddingHorizontal:24},eyebrow:{color:'#74828b',fontSize:9,letterSpacing:2.2,marginBottom:12},title:{color:'#092b45',fontSize:34,lineHeight:40,fontWeight:'500'},copy:{color:'#687780',fontSize:14,lineHeight:22,marginTop:12,marginBottom:28},code:{height:58,borderWidth:1,borderColor:'#cfd9de',fontSize:24,letterSpacing:10,textAlign:'center',color:'#092b45',marginBottom:14},button:{height:54,backgroundColor:'#092b45',alignItems:'center',justifyContent:'center'},disabled:{opacity:.45},buttonText:{color:'#fff',fontWeight:'700',fontSize:14},link:{textAlign:'center',color:'#74828b',fontSize:12,marginTop:18,textDecorationLine:'underline'}})

...
export default function InterviewReady(){
  ...
  return <ScrollView style={styles.scroll} contentContainerStyle={styles.page}>
    ...
    {loading?<ActivityIndicator color="#092b45" style={{marginTop:24}}/>:<>
...
const styles=StyleSheet.create({
  scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:18,paddingBottom:34},back:{color:'#66747c',fontSize:14,marginBottom:26},eyebrow:{color:'#71808a',fontSize:8,letterSpacing:2,marginBottom:8},title:{color:'#092b45',fontSize:29,lineHeight:34,fontWeight:'500'},intro:{color:'#66747c',fontSize:13,lineHeight:20,marginTop:8,marginBottom:20},
  creditCard:{backgroundColor:'#f4f7f8',padding:17,alignItems:'center'},creditNumber:{color:'#092b45',fontSize:31,fontWeight:'600'},creditLabel:{color:'#71808a',fontSize:8,letterSpacing:1.5,marginTop:3},locked:{borderWidth:1,borderColor:'#dce3e7',padding:16,marginTop:12},lockTitle:{color:'#173246',fontSize:13,fontWeight:'600'},lockCopy:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:5},
  section:{color:'#092b45',fontSize:17,fontWeight:'600',marginTop:24,marginBottom:10},list:{gap:9},card:{borderWidth:1,borderColor:'#dce3e7',padding:16},job:{color:'#173246',fontSize:15,fontWeight:'600'},meta:{color:'#71808a',fontSize:11,marginTop:5},prepareButton:{backgroundColor:'#092b45',paddingVertical:12,alignItems:'center',marginTop:13},prepareDisabled:{opacity:.42},prepareText:{color:'#fff',fontSize:11,fontWeight:'600'},
  empty:{backgroundColor:'#f4f7f8',padding:18},emptyTitle:{color:'#173246',fontSize:14,fontWeight:'600'},emptyCopy:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:5},result:{marginTop:18,borderWidth:1,borderColor:'#dce3e7',padding:17},resultEyebrow:{color:'#71808a',fontSize:8,letterSpacing:1.6},resultTitle:{color:'#092b45',fontSize:21,fontWeight:'600',marginTop:7},resultMeta:{color:'#71808a',fontSize:11,marginTop:4},
  readiness:{backgroundColor:'#f4f7f8',padding:14,marginTop:15,flexDirection:'row',alignItems:'center',gap:12},readinessNumber:{color:'#092b45',fontSize:25,fontWeight:'600'},readinessLabel:{color:'#66747c',fontSize:8,letterSpacing:1.1},readinessCopy:{color:'#526976',fontSize:10,lineHeight:15,marginTop:3},
  resultSection:{borderTopWidth:1,borderTopColor:'#e4e9ec',paddingTop:15,marginTop:17},resultSectionTitle:{color:'#173246',fontSize:14,fontWeight:'600',marginBottom:7},body:{color:'#66747c',fontSize:11,lineHeight:18},bullets:{gap:6,marginTop:2},bulletRow:{flexDirection:'row',gap:7},bullet:{color:'#092b45',fontSize:12},bulletCopy:{color:'#66747c',fontSize:11,lineHeight:17,flex:1},hardCard:{backgroundColor:'#f7f9fa',padding:14,marginTop:10},hardLabel:{color:'#71808a',fontSize:8,letterSpacing:1.1},hardQuestion:{color:'#173246',fontSize:12,fontWeight:'600',lineHeight:18,marginTop:6},source:{color:'#8a969d',fontSize:9,lineHeight:14,marginTop:17}
})

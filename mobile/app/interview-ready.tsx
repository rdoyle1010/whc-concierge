  ...
  return <ScrollView style={styles.scroll} contentContainerStyle={styles.page}>
    ...
    {loading?<ActivityIndicator color="#0b2f4d" style={{marginTop:24}}/>:<>
      ...
      {prep ? <View style={styles.result}>
        ...
        <Text style={styles.source}>{prep.source?.hasCv?'Your CV was included. ':'Your Talent House profile was used. '}{prep.source?.usedAi?'AI coaching added.':'Role-based coaching prepared.'}</Text>
      </View> : null}

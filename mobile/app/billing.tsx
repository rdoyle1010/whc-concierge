...
const styles = StyleSheet.create({
  scroll:{flex:1,backgroundColor:'#fff'},page:{paddingHorizontal:22,paddingTop:64,paddingBottom:120},center:{flex:1,alignItems:'center',justifyContent:'center',padding:24,backgroundColor:'#fff'},back:{color:'#66747c',fontSize:13,marginBottom:34},eyebrow:{color:'#71808a',fontSize:9,letterSpacing:2.1,marginBottom:10},title:{color:'#0b2f4d',fontSize:30,lineHeight:36,fontWeight:'500'},intro:{color:'#66747c',fontSize:14,lineHeight:21,marginTop:10,marginBottom:24},currentCard:{backgroundColor:'#f4f7f8',padding:18,marginBottom:28},row:{flexDirection:'row',justifyContent:'space-between',gap:12},label:{color:'#71808a',fontSize:8,letterSpacing:1.5},plan:{color:'#0b2f4d',fontSize:24,fontWeight:'600',marginTop:4},status:{color:'#456655',fontSize:9,fontWeight:'700',letterSpacing:1.1,paddingTop:4},line:{color:'#66747c',fontSize:11,lineHeight:17,marginTop:7},sectionTitle:{color:'#173246',fontSize:17,fontWeight:'600',marginBottom:10,marginTop:6},card:{borderWidth:1,borderColor:'#dce3e7',padding:18,marginBottom:11},miniCard:{borderWidth:1,borderColor:'#e2e8eb',padding:16,marginBottom:10},cardTitle:{color:'#173246',fontSize:17,fontWeight:'600'},price:{color:'#0b2f4d',fontSize:20,fontWeight:'600',marginTop:5},copy:{color:'#71808a',fontSize:11,lineHeight:17,marginTop:7},primary:{backgroundColor:'#0b2f4d',paddingVertical:14,alignItems:'center',marginTop:14},primaryText:{color:'#fff',fontSize:11,fontWeight:'700'},secondary:{borderWidth:1,borderColor:'#cbd7dc',paddingVertical:13,alignItems:'center',marginTop:14},secondaryText:{color:'#173246',fontSize:11,fontWeight:'600'},activeBox:{backgroundColor:'#eef5f0',padding:16,marginBottom:11},activeTitle:{color:'#456655',fontSize:14,fontWeight:'700'},link:{color:'#0b2f4d',fontSize:10,fontWeight:'700',marginTop:10},error:{color:'#9b2c2c',fontSize:11,lineHeight:17,marginBottom:14}
})
